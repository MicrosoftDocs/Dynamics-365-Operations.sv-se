...
description: "Den här artikeln beskrivs hur du kan anpassa Microsoft Dynamics 365 för operationer."
author: RobinARH
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Den här artikeln beskrivs hur du kan anpassa Microsoft Dynamics 365 för operationer.

Det finns många typer av anpassningar i Microsoft Dynamics 365 för operationer. Vissa anpassningsalternativ är val som du gör i en lista över alternativ på en inställningssida. Vissa anpassningar är implicit, till exempel Dynamics 365 för operationer håller reda på kolumnbredd rutnätet om du justerar dem och expanderat/komprimerat köttets snabbflikar. Andra anpassningsalternativ är tydlig. För explicita anpassningsalternativ anger du en interaktiv anpassningsläget och ändra utseende på en sida genom att direkt administrera så att element eller agera på sidan. 

Alla anpassningar av olika typer, som en användare gör i Dynamics 365 för operationer för användaren, oavsett det företag som användaren interagerar med. Ändringar som en användare gör att en sida inte påverka andra användare i systemet.

## <a name="systemwide-options-for-the-current-user"></a>Systemtäckande alternativ för den aktuella användaren
...
-   **Inställningar:** här väljer du standardvärden för varje gång du öppnar Dynamics 365 för operationer, inklusive företag, startsida och standard/redigeringsläge (som avgör om en sida är låst för visning eller öppnas för redigering i varje gång du öppnar den). Du skar finner dessutom språk, tidszon och datum, tid och antal formatalternativ. Slutligen den här sidan innehåller ett antal diverse inställningar som varierar från version till version.
...
**Rutnätskolumner:** Du kan justera bredden på en kolumn i en lista genom att välja storlekssortering bar till vänster eller till höger om kolumnrubriken och skjuta den åt vänster eller höger till önskad bredd. Dynamics 365 för operationer lagras i bredd som du skulle ha och mot den bredden som kolumnen visas varje gång du öppnar sidan med listan. 

**Snabbflikar:** Vissa sidor har expanderbara avsnitt som kallas snabbflikar. Dynamics 365 för operationer vilka snabbflikar lagrar du utökade antalet och vilka snabbflikar har är dolda. Varje gång du kommer tillbaka till sidan, samma snabbflikens kommer att utökas eller krympas baserat på den senaste gången du använde dem. I denna artikel beskriver vi hur du vill ändra ordning på snabbfliken sektioner. I vissa fall kan dölja en snabbflik prestanda förbättras eftersom Dynamics 365 för operationer inte behöver hämta information om den snabbfliken tills snabbfliken expanderas. 

**Faktarutor:** Vissa sidor har ett avsnitt som kallas faktaruta. Den här rutan innehåller skrivskyddad information relaterad till det aktuella ämnet på sidan. Varje avsnitt i faktaruta rutan kallas en faktaruta. Du kan visa eller dölja en ruta faktum och Dynamics 365 för operationer sparas inställningarna. I vissa fall kan kan en ruta för att dölja prestanda förbättras eftersom Dynamics 365 för operationer inte behöver hämta Faktarutan tills Faktarutan är expanderad.
...
Varje person och företag har olika perspektiv på vilka data som är viktigast för dem, eller vilka data finnas inte nödvändigt för det sätt de sköter sina affärer. Möjligheten att anpassa hur informationen är ordnad interagerande med och även är dolda nyckeln till att få Dynamics 365 för en produktiv och personlig erfarenhet. 

Explicit anpassningar är de anpassningar du uttryckligen med avsikt att ändra utseende och funktion för ett element eller en sida genom att välja en meny för anpassning. Den vanligaste typen av anpassning explicit är ett element högerklickar du och väljer **anpassa**. (Observera att inte alla element på sidan kan anpassas). När du väljer den här metoden för anpassning visas elementets egenskapsfönster. 
...
[![Anpassa verktygsfältet](./media/personalization-personalizationtoolbar.jpg)](./media/personalization-personalizationtoolbar.jpg)

Anpassa verktygsfältet innehåller ett antal åtgärder för anpassning. **Verktyget Välj** när du vill välja och ändra egenskaperna för många element, ett i taget. Först genom att klicka på verktyget Välj och klicka sedan på element vars egenskaper du vill redigera. När du väljer ett element, elementet egendom fönster öppnas och du kan ändra egenskaperna för det elementet. Du kan upprepa processen för andra element på din blankett som personanpassning. I vissa fall kan du välja ett element och se att vissa egenskaper inte ändras. Detta innebär att baserat på hur det aktuella elementet används, Dynamics 365 för åtgärder som inte kan du ändra egenskapen. Exempelvis du kan skinnet en fält som krävs. 

Välj **verktyget Flytta** när du vill välja och flytta en del till en annan plats inom aktuell grupp av element. (Du kan inte flytta ett inslag utanför dess överordnade grupp). Klicka först flytta verktyget och klicka sedan på det element som du vill flytta. När du klickar på det element som du vill flytta Dynamics 365 för operationer söks formuläret där detta element kan flyttas och skapa en serie "släppzoner" som visas som en färgad linje fet bredvid området där elementet kan tas bort medan du drar elementet runt den aktuella gruppen. 

Välj **Dölj** verktyg att välja och döljer en del. För att dölja en del, välj helt enkelt dölja verktyg och klicka på de element som du vill dölja. När du väljer att dölja verktyg, alla dolda element kommer att göras synliga och visas i en skuggig behållare så att du kan välja elementet för att visa det igen. Välj verktyg för att se hur han sida kommer att se ut med de valda element dolda. Välj **sammanfattning** verktyg när du vill ha en numeriskt värde eller sträng att visa i snabbfliken sammanfattning området. Sammanfattningen verktyg kommer endast att gälla områden som är inneslutna i en snabbfliken avsnitt. När du väljer verktyget sammanfattning visas alla fält som har valts som sammanfattningsfält genom att skriva dem i en behållare som skuggade Dynamics 365 för operationer. Du kan interaktivt lägga till och ta bort fält från ett snabbfliken sammanfattning genom att klicka på fältet. 

Välj den **hoppa över** för att ta bort ett element från sidans flik tangentsekvens. När du väljer Hoppa över verktyget är överhoppade alla element visas i en skuggad behållare så att du kan välja dem igen så att de ingår i serien genom att markera ett överhoppade fliken. 
...
Välj den **hantera** för att visa en lista över alternativ som är relaterad till alla anpassningar för den aktuella sidan. 

Välj **radera** installationstillstånd att återställa sidan till dess standardfärg. Alla anpassningar på den aktuella sidan kommer att rensas. Det finns ingen Ångra-åtgärd, så att bara använda det här alternativet om du är säker på att du vill återställa sidan. 
...
Del arbetsytor innehåller antalet rutor (brickor med nummer på dem) som också ska visas på instrumentpanelen. Högerklicka på en bricka om inventeringen i arbetsytan, och välj **anpassa**. Välj **PIN-kod för att instrumentpanelen**. Nästa gång du navigerar till (och uppdatera de valda instrumentpanelen ser du att räkna under arbetsytan navigeringsmeny panel på instrumentpanelen.

## <a name="explicit-personalization-personalizing-your-dashboard"></a>Explicit anpassning: Anpassa din instrumentpanel
Instrumentpanelen är ofta den första sidan som visas när du öppnar Dynamics 365 för operationer. Du kan anpassa instrumentpanelen för att döpa din arbetsyta navigation paneler, för att endast visa panelerna som du skulle vilja se, byta panel, eller arrangerar panelerna i den ordning du föredrar att se dem. För att anpassa instrumentpanelen, välj någon panel och högerklicka för att öppna en snabbmeny. På snabbmenyn, välj **Anpassa**. Om den valda panelen är samma som du vill dölja eller ändra namn på eller hoppa över, du kan göra ändringar direkt i fönstret med egenskaper som har visats. Om du vill ordna paneler, välj sedan **anpassa denna form** i fastigheten för att öppna verktygsfältet anpassning. Sedan kan du använda verktyget Flytta till arrangerar panelerna.
