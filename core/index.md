---
title: "Introduktion till Dynamics 365 för operationer"
description: "Microsoft Dynamics 365 för operationer är Microsofts affärsprogram för företag. Den här sidan kan du lära dig och börja använda produkten."
author: margoc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
---
# <a name="introduction-to-dynamics-365-for-operations"></a>Introduktion till Dynamics 365 för operationer

[!include[banner](includes/banner.md)]

Microsoft Dynamics 365 för operationer är Microsofts affärsprogram för företag. Det gör att snabbt fatta smartare beslut via ett intelligent användargränssnitt som ger åtkomst till information i realtid och data. Tack vare beprövade affärslogik att konstruera affärsprocesserna snabbare kan företag transformeringen och innnovate. Den ger företag möjlighet att växa i sin egen takt och arbeta nästan var som helst, när som helst, så att de kan skalas globalt så att de passar företagets behov verksamheten. 

Den här användarhandboken enklare Läs Dynamics 365 för operationer som passar ditt företag.    
...
<tbody>
<tr class="odd">
<td><p><a href="get-started/onboarding-home.md">Inledande organisationen</a></p>
<p>Ekonomi</p>
...
<p>Personal</p>
   <ul>
  <li><a href="human-resources/departments-jobs-positions.md">Strategi för personal</a></li>
  <li><a href="human-resources/manage-recruiting-process.md">Rekrytera, anställa och motivera</a></li>
  <li><a href="human-resources/performance-management-overview.md">Personalens utbildning</a></li>
...
<li><a href="retail/call-center-functionality.md">Call center</a></li>
  ...
  <li><a href="retail/define-maintain-channel-clients-registers-hw-stations.md">POS MOPS och moln</a></li>
  <li><a href="retail/dev-itpro/dev-retail-home-page.md">Retail-utvecklare och administration</a></li></ul>
...
<li><a href="supply-chain/cost-management/costing-sheets.md">Cost management</a></li>
  ...
  <p>& Info för utvecklare admin-funktion</p>
