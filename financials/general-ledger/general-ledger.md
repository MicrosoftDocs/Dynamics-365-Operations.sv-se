...
description: "Använd redovisningen när du vill definiera och hantera den juridiska personens ekonomiska poster. Redovisningen är ett register för debet- och kreditposter. Dessa poster är klassificerade med hjälp av de konton som listas i en kontoplan."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
