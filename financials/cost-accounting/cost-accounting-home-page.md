...
-   Skapa kostnadsstyrenheter.
-   Bearbeta redovisningsposter.
-   Bearbeta budgetposter.
-   Skapa och tillämpa kostnadsbeteendepolicyer.
-   Spårkostnader.
-   Definiera dimensionshierarkier.
...
De praktiska övningarna för kostnadsredovisning ger grundläggande steg för att konfigurera Microsoft Dynamics 365 for Finance and Operations, Enterprise edition – Kostnadsredovisning för att skapa den faktiska kostnadsanalysen. De innehåller även ett antal procedurer som du kan utföra i den ordning som de visas.
...
-   [Ställ in säkerheten för Power BI-innehåll för kostnadsredovisningsinnehållet](/dynamics365/unified-operations/dev-itpro/analytics/setup-security-cost-accounting-content-pack)
