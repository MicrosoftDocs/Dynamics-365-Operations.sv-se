...
Följande inlärningskarta visar viktiga begrepp och aktiviteter med anslutningslinjer mellan närliggande aktiviteter som tillsammans beskriver kostnadsredovisningsmodulen.

![Inlärningskarta för kostnadsredovisning](./media/cost-accounting-map.png)

## <a name="get-started-videos"></a>Komma igång-videor
