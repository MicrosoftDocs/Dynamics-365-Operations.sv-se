...
| **Fält**                             | **Beskrivning**             |
|---------------------------------------|--------------------------------------------------------------------------------------|
|**Lägsta antal timmar för dagtraktamente**           | Ange minsta antal timmar som en medarbetare måste arbeta under en dag för att kunna få traktamente för reserelaterade utgifter.                                                                                      |
