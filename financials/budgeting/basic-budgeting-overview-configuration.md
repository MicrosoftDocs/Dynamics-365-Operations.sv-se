...
description: "I stort sett alla företag som använder funktionen ekonomi i Microsoft Dynamics 365 for Operations måste kunna skapa rapporter över budget kontra faktiska värden. Den här artikeln beskriver den minimikonfiguration som krävs för att skapa budgetar i Dynamics 365 for Operations eller läsa in dem från ett tredjepartsprogram."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
I stort sett alla företag som använder funktionen ekonomi i Microsoft Dynamics 365 for Operations måste kunna skapa rapporter över budget kontra faktiska värden. Den här artikeln beskriver den minimikonfiguration som krävs för att skapa budgetar i Dynamics 365 for Operations eller läsa in dem från ett tredjepartsprogram.
