...
description: "Du kan använda Kontanthantering och bankhantering för att underhålla juridiska personens bankkonton och ekonomiska verktyg som är kopplade till dessa bankkonton."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
-   [Remburs och importinkasso](letters-of-credit-import-collections.md)
...
-   [Ställ in matchningsregler för bankavstämning](set-up-bank-reconciliation-matching-rules.md)
-   [Ställa in centraliserade betalningar](set-up-centralized-payments.md)
...
-   [Scenario: Kassarabatt för överbetalningar hantering av](../cash-bank-management/cash-discount-handling-overpayments.md)
