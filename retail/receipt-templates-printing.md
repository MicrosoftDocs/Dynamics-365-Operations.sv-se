...
description: "Den här artikeln beskriver hur du ändrar formulärlayouter om du vill styra hur kvitton, fakturor och andra dokument skrivs ut. Microsoft Dynamics 365 för verksamhet – Retail finns en Layoutdesigner för formulär som du kan använda för att enkelt skapa och ändra olika typer av formulärlayouter."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Den här artikeln beskriver hur du ändrar formulärlayouter om du vill styra hur kvitton, fakturor och andra dokument skrivs ut. Microsoft Dynamics 365 för verksamhet – Retail finns en Layoutdesigner för formulär som du kan använda för att enkelt skapa och ändra olika typer av formulärlayouter.

**Viktigt:** måste du ställa in formulärlayouter och inleverans för att skriva ut kvitton och andra dokument från Retail POS för Modern och molnbaserad kassa profiler. Du kan inkludera flera formulärlayouter i en kvittoprofil. Du kan sedan tilldela mottagandet profil till en skrivare genom att modifiera hårdvara profil.

## <a name="set-up-a-receipt-format"></a>Ställa in en kvittoformat
1.  Klicka på **butik och handel**&gt;**kanal**&gt;**POS inställningar**&gt;**POS**&gt;**format för inleverans**.
...
5.  När installationen är klar, ange Dynamics 365 operationer användarnamn och lösenord och klicka på **inloggning** starta designern.
...
1.  Öppna maskinvaruprofilen genom att klicka **butik och handel**&gt;**kanal**&gt;**POS inställningar**&gt;**profiler för kassa**&gt;**maskinvaruprofil**.
