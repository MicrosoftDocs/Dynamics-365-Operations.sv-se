...
description: "Det här avsnittet beskriver hur du använder uppgiftsinspelaren i Retail Modern POS (MPOS) och Cloud POS."
author: mugunthanm
manager: AnnBe
ms.date: 2017-05-15
ms.topic: article
...
Det här avsnittet beskriver hur du använder uppgiftsinspelaren i Retail Modern POS (MPOS) och Cloud POS.
...
1.  Klicka på **Butik och handel** &gt; **Kanalinställningar** &gt; **Kassainställningar** &gt; **Register**.
...
4.  Klicka på **Spara**.
5.  Gå till **Butik och handel** &gt; **Butikens IT** &gt; **Distributionsschema**.
...
## <a name="help-at-retail-modern-pos-and-cloud-pos"></a>Hjälp med Retail Modern POS och Cloud POS
Om du vill visa dina egna anpassade uppgiftsinspelningar i hjälpfönstret för Retail Modern POS och Cloud POS så att de kan spelas upp text, så måste du spara dina uppgiftsinspelningar i ditt eget BPM-bibliotek och sedan uppdatera hjälpsystemparametrarna så att de pekar på ditt BPM-bibliotek. Mer information finns i [Ansluta hjälpsystemet](https://ax.help.dynamics.com/en/wiki/working-with-help/#connecting-the-help-system). Retail Modern POS och Cloud POS Help söker LCS i realtid. Det söker igenom alla BPM-bibliotek som valts i systemparametrarna för Microsoft Dynamics AX Help och visar relevanta resultat. För att få åtkomst till menyn **Hjälp** klickar du på knappen **Hjälp** högst upp på skärmen. Ange sedan ditt processnamn i sökrutan och tryck på sökknappen. 

[![Knappen Hjälp](./media/help.jpg)](./media/help.jpg) 

När du klickar på en uppgiftsguide i sökresultaten kan du antingen se stegen som ett hjälpavsnitt eller exportera stegen till ett Word-dokument. Obs: Hjälpsystemet i Modern Retail POS och Cloud POS medför inte uppgiftsguiderna automatiskt utifrån ditt formulär eller dina operationer. Du måste ange processnamnet i sökrutan och tryck på sökknappen för att få se resultaten.
