...
### [Frågor och svar för utveckling och kontinuerlig leverans](dev-tools/continuous-delivery-faq.md)
...
### [Versionsmodeller i automatiskt skapande](dev-tools/version-models-build.md)
...
### [Frågor och svar för meddelandecenter, meddelandefält och meddelandeinformation](user-interface/messaging-user.md)
...
### [Tillämpa ett distribuerbart paket](deployment/apply-deployable-package-system.md)
...
### [Analysera - Distribuera ett begränsat läge](migration-upgrade/analysis-sandbox.md)
...
### [Uppgradera till den senaste plattformsuppdateringen](migration-upgrade/upgrade-latest-platform-update.md)
...
## [Synkronisera BPM-bibliotek med Visual Studio Team Services (VSTS)](lifecycle-services/synchronize-bpm-vsts.md)
...
## [Återställ en databas i en miljö för icke-produktion](database/request-point-in-time-restore.md)
## [Exportera en kopia av en databas som ska återställas senare](database/copy-operations-database.md)

# Support
## [Få support för Dynamics 365 for Finance and Operations, Enterprise Edition och Lifecycle Services](lifecycle-services/lcs-support.md)
...
## [Frågor och svar om fönster för planerat underhåll](lifecycle-services/planned-maintenance-window-faq.md) 
