---
title: "Generera rapporter genom att lägga till innehåll som råa XML-dokument"
description: "Du kan utforma elektronisk rapportering (ER)-format som genererar utgående dokument i XML-format."
author: NickSelin
manager: AnnBe
ms.date: 05/25/2018
ms.topic: article
...
# <a name="generate-er-reports-by-adding-content-as-raw-xml"></a>Generera ER-rapporter genom att lägga till innehåll som råa XML-dokument

[!include[banner](../includes/banner.md)]

Du kan använda **RÅA XML**-formatelement för att utforma format för elektronisk rapportering (ER) som genererar utgående dokument i XML-format. I vissa fall kanske du vill lägga till obearbetad XML-data i dessa rapporter av en eller flera av följande orsaker:

- Det är bekvämare att använda råa XML-dokument för den ursprungliga designen och löpande underhåll av en rapport eftersom XML-strukturen kan genereras automatiskt genom att köra ett uttryck för körning. Därför måste inte flera bindningar fastställas för flera formatelement när du designar. Det är möjligt när du använder datakällor som innehåller information som kan användas för att göra XML-element medan rapporten genereras. 
