...
---
# <a name="define-the-dependency-of-configurations-from-othcomponents-for-electronic-reporting-er"></a>Definiera beroendet av konfigurationer från andra komponenter för elektronisk rapportering (ER)
