...
13. Klicka på Redigera destination.
    ...
    * Om mappningen anropas från en punkt i Dynamics 365 for Finance and Operations, Enterprise edition-programmet (t.ex. en knapp eller ett menyobjekt) som är särskilt utformat för denna åtgärd, ska ER-målet markeras som integreringspunkt. I det här exemplet är detta punkten ERTableDestination#VendSettlementTax1099.  
14. Klicka på Avbryt.
