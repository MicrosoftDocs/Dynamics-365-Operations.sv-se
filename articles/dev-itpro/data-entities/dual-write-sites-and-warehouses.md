...
I det här avsnittet beskrivs integreringen av plats- och lagerställedata mellan Finance and Operations och Common Data Service. Driftplatser och driftlagerställen är vanliga koncept i ett hanteringsprogram för leveranskedjor. De används för att modellera leveranskedjan för ditt företag.
