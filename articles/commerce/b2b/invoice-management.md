...
description: Det här ämnet beskriver fakturahantering i Microsoft Dynamics 365 Commerce B2B-näthandelssajter.
author: shajain
ms.date: 02/16/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8312595"
---
# <a name="invoice-management-for-b2b-e-commerce-websites"></a>Fakturahantering för B2B-näthandelssajter

[!include [banner](../../includes/banner.md)]

Det här ämnet beskriver fakturahantering i Microsoft Dynamics 365 Commerce B2B-näthandelssajter.
...
> [!NOTE]
> En inloggad användare kan bara visa och betala sina egna fakturor. Om ett organisationskonto är konfigurerat på rullgardinsmenyn **Fakturakonto** på snabbfliken **Faktura och leverans** i kundposten i Commerce-administration, kommer användaren att kunna se och betala fakturor för organisationskontot.
...
När en användare har begärt en faktura flyttas denna begäran till avsnittet **B2B-förfrågningar** på sidan **Mitt konto**. Sedan, efter att **P-0001** och **Synkronisera order och jobb för kanalbegäran** har körts i Commerce-administration, utlöses e-postmeddelandet med fakturan och statusen för B2B-begäran markeras som slutförd.
