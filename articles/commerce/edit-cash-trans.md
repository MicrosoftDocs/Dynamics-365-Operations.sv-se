...
description: I det här avsnittet beskrivs hur du redigerar och granskar hämtköpstransaktioner och transaktioner för kassahantering i Microsoft Dynamics 365 Commerce.
author: josaw1
manager: AnnBe
ms.date: 11/04/2020
ms.topic: index-page
...
I det här avsnittet beskrivs hur du redigerar och granskar hämtköpstransaktioner och transaktioner för kassahantering i Microsoft Dynamics 365 Commerce.
