...
description: Denna artikel ger en översikt över momsgruppsval för olika typer av onlinebeställning i Dynamics 365 Commerce.
...
ms.locfileid: "8906896"
---
# <a name="configure-sales-tax-for-online-orders"></a>Konfigurera moms för onlinebeställningar

[!include [banner](includes/banner.md)]

Denna artikel ger en översikt över momsgruppsurval för olika onlineordertyper med hjälp av antingen destinationsbaserade eller kundkontobaserade skatteinställningar. 
