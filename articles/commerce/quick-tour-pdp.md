...
Den viktigaste modulen på ett PDP är modulen inköpsruta. Därför är det den första artikeln i huvudavsnittet på sidan. Modulen inköpsruta är en behållarmodul och innehåller flera moduler som innehåller den viktigaste informationen om produkten. Denna information omfattar produktnamn, produktbilder, beskrivning, pris och produktvärderingar.
...
Modulen för produktspecifikationer kan användas för att visa mer information om produkten. Dessa detaljer hämtas från produktattribut i Dynamics 365 Retail. Modulen produktspecifikationer visar alla attribut där egenskapen **synlig** är inställd på **sant**. Det kräver ett produkt-ID för att hämta produktattribut.
...
- En **relaterad** lista kan konfigureras för en produkt i Retail. För till exempel en handväska i brunt läder kan flera handväskor som är läderbaserade eller utformade för resor konfigureras för den relaterade listan. Andra typer av relaterade listor, till exempel **tillbehör** och **Fler som den här**, kan också konfigureras i Retail. Ett produkt-ID krävs för att listan ska kunna skapas. Om den läggs till på en startsida, där sidkontexten inte innehåller något produkt-ID, kommer listan att vara tom.
...
## <a name="ratings-and-reviews-module"></a>Moduler för omdömen och recensioner

I modulen omdömen och recensioner visas omdömen och recensioner som andra kunder har gett. Det gör också att kunden kan skriva sin egen granskning av produkten. Dessutom innehåller den ett histogram som visar klassificeringstrenden för produkten. Mer information finns i [Översikt över omdömen och recensioner](ratings-reviews-overview.md).

## <a name="marketing-modules"></a>Marknadsföringsmoduler

Om marknadsföringsinnehållet är unikt för en viss produkt kan en marknadsföringsmodul läggas till i PDP. Du kan lägga till marknadsföringsmaterial i ett PDP genom att "berika" sidan. 
