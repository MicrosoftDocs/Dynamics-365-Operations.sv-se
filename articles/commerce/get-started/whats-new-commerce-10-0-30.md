...
| Insikter  |  Streama kassa (POS) Operational Insights händelser till din Application Insights konto. | [Komma åt loggar i Application Insights](../dev-itpro/operational-insights.md#enable-diagnostic-events-in-application-insights)   |  Välj IT-proffs/utvecklare   |
