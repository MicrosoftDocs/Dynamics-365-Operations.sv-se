...
> [!NOTE]
> Innan du försöker integrera Uppgiftshantering med Teams måste du kontrollera att du har aktiverat [Dynamics 365 Commerce och Microsoft Teams integrering](enable-teams-integration.md). 
...
> [!NOTE]
> När uppgiftslistan har publiceras i Teams visas uppgifterna i POS. POS-chefer och kassörer måste sedan aktivera inloggning Azure AD i POS. Mer information finns i artikeln [Aktivera Azure Active Directory autentisering för POS-inloggning ](aad-pos-logon.md). 
