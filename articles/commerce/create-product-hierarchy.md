...
En produkthierarki för Handel används för att definiera den allmänna produkthierarkin för din organisation. Du kan använda en produkthierarki för Handel för marknadsföring, prissättning och kampanjer, rapportering och sortimentplanering. Endast en produkthierarki för Handel tilldelas per organisation.

## <a name="create-and-configure-a-product-hierarchy"></a>Skapa och konfigurera en produkthierarki

Följ stegen nedan om du vill skapa och konfigurera en produkthierarki för Handel.

1. I Navigeringsfönstret, gå till **Moduler \> Butik och handel \> Produkter och kategorier \> produkthierarki för Handel**.
...
[Ändra sorteringsordning för marknadsföringsenheter](custom-order-categories-nav-retail-prod-hierarchy.md)
