...
description: I denna artikel beskrivs hur du skapar adressböcker i Microsoft Dynamics 365 Commerce.
author: samjarawan
ms.date: 01/27/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9281492"
---
# <a name="create-new-address-book"></a>Skapa en ny adressbok

[!include [banner](includes/banner.md)]

I denna artikel beskrivs hur du skapar en ny adressbok i Microsoft Dynamics 365 Commerce.
...
Följ dessa steg för att skapa en ny adressbok.
 
1. I navigeringsfönstret, gå till **Moduler \> Kanalinställningar \> Adressböcker**.
1. Välj **Ny** i åtgärdsfönstret.
1. Ange namn- och beskrivningsinformation.
