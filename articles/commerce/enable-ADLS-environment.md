...
description: Denna artikel innehåller instruktioner om hur du ansluter en Azure Data Lake Storage Gen 2-lösning till Dynamics 365 Commerce-miljöns enhetslagring. Detta är ett nödvändigt steg innan du aktiverar produktrekommendationer.
author: bebeale
ms.date: 08/31/2020
ms.topic: article
ms.prod: ''
...
Denna artikel innehåller instruktioner om hur du ansluter en Azure Data Lake Storage Gen 2-lösning till Dynamics 365 Commerce-miljöns enhetslagring. Detta är ett nödvändigt steg innan du aktiverar produktrekommendationer.
