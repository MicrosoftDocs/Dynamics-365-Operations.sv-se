...
Beräkningslogiken på kanalsidan returnerar ett uppskattat fysiskt tillgängligt värde och ett totalt tillgängligt värde för den begärda produkten och lagerstället. Värdena kan visas på din näthandelsplats om du vill det, eller så kan de användas för att utlösa annan affärslogik på din näthandelswebbplats. Du kan till exempel visa meddelandet "brist på lager" i stället för den faktiska behållningskvantiteten som har godkänt API.
...
- **P-Jobb** – p-jobbet finns på sidan **distributionsplaner** och bör köras ofta. Det här jobbet ger näthandelsorder, asynkrona kundorder som skapats av kassan och hämtköporder som skapas från kanaldatabaser till Commerce-administration, så att de kan bearbetas ytterligare. Innan dessa data synkroniseras från kanalen till Commerce-administration har inte Commerce-administration någon information om lagerjusteringar till produkter i de lagerställen som kommer från dessa transaktioner.
