...
### <a name="enable-features-for-norway"></a>Aktivera funktioner för Norge

Du måste aktivera följande funktioner i **Funktionshantering** för Commerce headquarters:

- (Norge) Aktivera ytterligare granskningshändelser i kassan
- (Norge) Aktivera ytterligare information i dagsavstämningutdrag i kassan
