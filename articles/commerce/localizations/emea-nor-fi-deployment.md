...
description: Det här avsnittet innehåller information om hur du aktiverar kassaregisterfunktionen för Microsoft Dynamics 365 Commerce lokalisering för Norge.
...
Det här avsnittet innehåller information om hur du aktiverar kassaregisterfunktionen för Microsoft Dynamics 365 Commerce lokalisering för Norge. Lokaliseringen består av flera utvidgningar av komponenter. Dessa tillägg låter dig utföra åtgärder som att skriva ut anpassade fält på kvitton, registrera ytterligare revisionshändelser, försäljningstransaktioner och betalningstransaktioner i försäljningsställe (POS), digital signering av försäljningstransaktioner och skriva ut rapporter i lokala format. Mer information om lokalisering för Norge finns i [Kassaregisterfunktionen för Norge](./emea-nor-cash-registers.md). Mer information om hur du ställer in Commerce för Norge finns i [Konfigurera Commerce för Norge](./emea-nor-cash-registers.md#setting-up-commerce-for-norway).
...
Följ dessa steg för att aktivera den skattemässiga registreringsprocessen för Norge i Commerce-administration.
...
1. Gå till **Retail och Commerce \> Kanalinställning \> Räkenskapsintegration \> Funktionsprofiler för koppling**. Skapa en ny funktionsprofil för koppling och välj dokumentleverantören och kopplingen som du laddade tidigare.
1. Gå till **Retail och Commerce \> Kanalinställning \> Räkenskapsintegration \> Tekniska profiler för koppling**. Skapa en ny teknisk profil för koppling och välj kopplingen som du laddade tidigare. Ange att kopplingstypen är **intern**.
...
1. Gå till **Retail och Commerce \> Kanalinställning \> Räkenskapsintegration \> Tekniska profiler för koppling**.
