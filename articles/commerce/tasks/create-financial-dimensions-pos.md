...
2. Klicka på Ny.
3. Välj ett alternativ i fältet Använd värden från.
...
10. Klicka på Spara.
11. Stäng sidan.
12. Gå till Butik och handel > kanalinställning > POS inställning > register.
13. Hitta och markera önskad post i listan.
14. Växla expansionen av avsnittet Ekonomiska dimensioner.
15. Klicka på Redigera.
16. Öppna sökningen genom att klicka på den nedrullningsbara knappen i fältet Terminal.
