...
Kunden försöker köra kompensationsprocessen i Microsoft Dynamics 365 Human Resources men lyckas inte med det.

**Orsak**

Kunden behöver dokumentationen.

**Upplösning**

Här är dokumentationen för kompensation:

- Inställning:

    - [Kompensationsplaner](https://docs.microsoft.com/dynamics365/unified-operations/talent/compensation-plans)
