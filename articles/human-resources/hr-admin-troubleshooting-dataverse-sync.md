...
description: I den här artikeln beskrivs hur du felsöker poster som inte synkroniseras korrekt mellan Microsoft Dynamics 365 Human Resources och HCM Common-lösningen (administration av humankapital) i Microsoft Dataverse.
author: jaredha
ms.date: 09/27/2021
ms.topic: article
ms.prod: ''
