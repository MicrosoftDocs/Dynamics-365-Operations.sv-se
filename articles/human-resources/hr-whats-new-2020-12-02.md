...
| 527316 | Titeländringar för jobb-, befattnings- och arbetstagarmeddelanden synkroniseras inte. | En titelrelation har tidigare lagts till i jobb-, befattnings- och arbetstagarentiteter. Synkroniseringen för den här relationen fungerar för synkroniseringen från personal till Common Data Service, men fungerade inte för meddelanden från Common Data Service. Detta har åtgärdats. |
