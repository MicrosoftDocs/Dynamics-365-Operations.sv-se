...
description: Denna artikel innehåller information om policyer för förmånsberättigande som definierar vem som är berättigad till specifika förmåner.
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
...
Denna artikel innehåller information om policyer för förmånsberättigande som definierar vem som är berättigad till specifika förmåner.
