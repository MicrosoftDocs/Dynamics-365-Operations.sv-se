...
- Organisationer som använder HR-modulen i Finance and Operations-appar får HR-funktionen för Dynamics 365 Human Resources som en del av den vanliga uppdateringsprocessen för One Version. Nya funktioner planeras bli allmänt tillgängliga från och med januari 2022.
...
- Organisationer som för närvarande bara använder Dynamics 365 Human Resources och andra Finance and Operations-appar kommer att ha tillgång till migreringsverktyg så att de kan börja testa och starta migreringen med början i slutet av 2022. Datumet då migreringen till den nya infrastrukturen måste ha slutförts har ännu inte bestämts. Den kommer dock att vara minst ett år efter det datum då verktyget för migrering blir tillgängligt.
...
Personaldata som för närvarande hanteras i Dynamics 365 Human Resources synkroniseras med Dataverse. Dataintegrerare kan sedan användas för envägssynkronisering med Finance and Operations-program. När du har migrerat till den nya infrastrukturerna kommer personaldata att inkluderas i Finance and Operations-apparna. Dataintegratorn behöver inte längre synkronisera data mellan Finance and Operations-appar och personal.
...
HR -data kommer att vara infödda till Finance and Operations-appar i miljön på den nya infrastrukturen. Dubbelriktad skrivning används för att flytta personaldata mellan den nya miljön och Dataverse-miljön.
...
Det beror på integreringsslutpunkten. För mer information om integreringstekniker som finns tillgängliga i Finance and Operations-appar och hur man väljer den bästa integreringstekniken, se [Översikt över Integrering](../fin-ops-core/dev-itpro/data-entities/integration-overview.md).
...
Om Dynamics 365 Human Resources och Finance and Operations-miljöer som kommer att förenas i miljön på den nya infrastrukturen är anslutna till sammaDataverse-miljö, kommer de två apparna att fortsätta att vara anslutna till samma Dataverse-miljö efter migreringen. Ingen migrering krävs för Dataverse-tillägg.
...
Personalmiljön förväntas vanligtvis ligga kvar i samma Azure-region under migreringen. Det enda undantaget inträffar om Personalmiljön kopplas till en Finance and Operations-miljö i en annan region. I det här fallet flyttas Human Resources-miljön till Azure-regionen i Finance and Operations-miljön.
