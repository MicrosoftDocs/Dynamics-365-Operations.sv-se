...
description: Det här avsnittet beskriver komponenterna som måste ställas in innan du kan använda variabel kompensation och registrera en medarbetare i en plan för variabel kompensation.
author: twheeloc
ms.date: 08/24/2021
ms.topic: article
ms.prod: ''
