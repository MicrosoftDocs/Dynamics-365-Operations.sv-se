...
## <a name="review-payroll-entities"></a>Granska löneentiteter

Använd detta API om du vill hämta en lista över de entiteter som har skapats och är klara för användning.
