...
ms.locfileid: "8066253"
---
# <a name="example-query-for-recruiting-request"></a>Exempelfråga för rekryteringsbegäran
...
Detta ämne utgör en exempelfråga för entiteten för rekryteringsförfrågningar i Dynamics 365 Human Resources.

Följande fråga visar hur du kan använda frågealternativet $expand i en GET-åtgärd för att hämta en angiven rekryteringsbegärandepost och alla associerade befattningar, obligatoriska färdigheter och utbildningskrav för den angivna begäran. Exempelsvaret visar en rekryteringsbegäran för två befattningar, samt de färdigheter och den utbildning som krävs för de begärda befattningarna.
