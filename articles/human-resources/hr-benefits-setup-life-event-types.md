...
| **Ändring av anställningsstatus** |<br><ul><li>Arbetare > Anställning</li><li>Sida för anställningshistorik</li></ul> | Om du skapar en ny anställningsdetalj med en annan anställningsstatus för en medarbetare med en befintlig anställningsdetalj, utlöser detta en livshändelse.  En uppdatering av en befintlig anställningsdetalj med en annan anställningsstatus utlöser också en livshändelse.  |
| **Ändring av medarbetarens adress** |<br><ul><li>Arbetare > Profil > Adresser</li><li>Arbetare > Personuppgifter > Personliga kontakter > Adress</li></ul> | Ändring i adress. Adressen måste vara **Primär** för att utlösa en livshändelse. |
