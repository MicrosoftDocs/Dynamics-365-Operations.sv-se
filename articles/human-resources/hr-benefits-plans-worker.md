...
3. Ange värden för de följande fälten:
   ...
   | Status | Filtrerar förmånsplaner utifrån deras status. Filtrera planerna för att hjälpa dig att välja en delmängd av alla planposter så att du kan bekräfta delmängden. |
   | Bekräftelse | Anger en bekräftelsestatus som ska användas för att filtrera planerna på snabbfliken planer. Filtrera planerna så att du kan välja en delmängd av alla planposter så att du kan bekräfta delmängden. |
   | Annullera | Anger annulleringsstatus som ska användas för att filtrera planerna på snabbfliken planer. Filtrera planerna så att du kan välja en delmängd av alla planposter så att du kan bekräfta delmängden. |
   | Filter för giltighetsdatum | Filtrerar planerna efter om de har förfallit, är aktiva eller kommer att vara aktiva i framtiden. Markera kryssrutorna som motsvarar de planer som du vill visa på snabbfliken abonnemang på snabbfliken planer. |
