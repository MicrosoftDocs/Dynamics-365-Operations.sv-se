...
description: Den här artikeln beskriver hur du öppnar enhetsdata i Microsoft Excel och sedan visar, uppdaterar och redigerar data med Microsoft Dynamics Excel-tillägget.
author: jasongre
ms.date: 05/16/2022
ms.topic: article
ms.prod: ''
