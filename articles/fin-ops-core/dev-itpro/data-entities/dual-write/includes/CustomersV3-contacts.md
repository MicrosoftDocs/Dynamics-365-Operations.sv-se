## <a name="customers-v3-to-contacts"></a>Kunder V3 till kontakter

Den här mallen synkroniserar data mellan Finance and Operations-appar och Common Data Service.

Källfilter: ((PartyType == "Person"))

Återfört källfilter: msdyn_sellable eq true  and msdyn_contactpersonid ne ''
