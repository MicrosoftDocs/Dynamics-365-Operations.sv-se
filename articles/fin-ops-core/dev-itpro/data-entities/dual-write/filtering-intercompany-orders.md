...
description: I den här artikeln beskrivs hur du filtrerar koncerninterna order så att entiteterna Order och OrderLines inte synkroniseras.
author: negudava
ms.date: 11/09/2020
ms.topic: article
