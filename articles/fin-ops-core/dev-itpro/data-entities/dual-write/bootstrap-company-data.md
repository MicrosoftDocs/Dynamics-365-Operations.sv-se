...
## <a name="why-do-i-need-bootstrapping"></a>Varför måste jag använda initiering? 
Du kanske har en befintlig Dataverse eller annan Dynamics 365-appinstans med affärsdata och du vill aktivera dubbelriktad anslutning mot den. I detta fall måste du initiera Dataverse eller andra Dynamics 365-appdata med företagsinformation innan du aktiverar dubbelriktad anslutning.  
 
## <a name="when-should-i-use-bootstrapping"></a>När ska jag använda initiering? 
Du bör använda initieringsfunktionen för att aktivera dubbelriktade tabellmappningar (under steg #5).  
1. Om du vill ställa in dubbelriktad anslutning mellan olika instanser av din Finance and Operations-app och Dataverse eller andra Dynamics 365-appar, loggar du in på Finance and Operations-appen som administratör. 
2. Gå till modulen **datahantering** och klicka på knappen **dubbelriktad**. Då startas **dataintegratorn**. 
3. Skapa dubbelriktad anslutning för ett eller flera företag.  
    > [!div class="mx-imgBorder"]
    > ![Skapa dubbelriktad anslutning](media/dual-write-boot-1.png)
4. Aktivera tabellmappningen **Cdm_companies**. Detta synkroniserar företag från Finance and Operations-appen till Dataverse.  
    > [!div class="mx-imgBorder"]
    > ![Aktivera tabellmappningen](media/dual-write-boot-2.png)
5. Kör exempelinitieringskoden på Dataverse eller andra Dynamics 365-appinstanser.  
6. När initieringen är klar och systemet är klart för live-synkronisering aktiverar du tabellmappningarna.  

    Om du aktiverar tabellmappningarna utlöses den inledande datasynkroniseringen för de aktiverade tabellmappningarna. De data som motsvarar de företag som valts för dubbelriktad anslutning synkroniseras mellan Finance and Operations-appen och Dataverse. 
 
## <a name="how-to-i-use-the-code-sample"></a>Hur ska jag använda kodexemplet?
Exempelkoden är ett C#-program som du kan läsa in i Visual Studio. Det krävs NuGet-paketberoenden på Dataverse SDK som du kan uppdatera via Visual Studio standardverktyg. 

När du har packat upp och öppnat lösningen i Visual Studio och återställt NuGet-paketen söker du efter **TODO** i koden. Varje beslut som du måste fatta om hur du vill initiera företagsinformation noteras genom **TODO** med exempelkod för en kanonisk implementering. 

Exempelkoden visar bara ett av många sätt som du kan kategorisera entitetsrader efter företag. Genom att ändra logiken i avsnitten **TODO** kan du skapa en anpassad kategorisering. 
