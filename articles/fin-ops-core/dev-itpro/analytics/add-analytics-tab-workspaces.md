...
description: Den här artikeln beskriver hur du bäddar in en Power BI-rapport på fliken analys i en arbetsyta.
author: RichdiMSFT
ms.date: 06/21/2017
ms.topic: article
ms.prod: ''
...
11. Ange egenskapen **bildtext** till **analys** och ange egenskapen **automatisk deklaration** till **Ja**.
...
Du har nu slutfört uppgiften att utöka definitionen för ansökningsformulär. Mer information om hur du använder tillägg om du vill göra anpassningar finns i [anpassa via tillägg och överlagring](../extensibility/customization-overlayering-extensions.md).
