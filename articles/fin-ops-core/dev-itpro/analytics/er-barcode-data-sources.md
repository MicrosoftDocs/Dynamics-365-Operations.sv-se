...
- [Bild](/office/client-developer/word/content-controls-in-word) innehållskontroll för Word
...
| Beskrivning av innehåll | Filnamn                 |
|---------------------|---------------------------|
| Rapportmall     | [Kontrollera mall Excel.xlsx](https://download.microsoft.com/download/3/b/d/3bd3b944-da8f-43b4-8533-3c1292a4c3ef/CheckTemplateExcel.xlsx) |
