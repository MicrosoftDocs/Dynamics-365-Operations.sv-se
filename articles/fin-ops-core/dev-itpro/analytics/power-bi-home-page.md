...
description: Den här artikeln listar PowerBI.com-lösningar som är tillgängliga och hänvisar till resurser där du kan lära dig mer om lösningen.
author: sericks007
ms.date: 10/02/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9206365"
---
# <a name="power-bi-content-home-page"></a>Power BI-innehåll – startsida

[!include [banner](../includes/banner.md)]

Följande PowerBI.com-lösningar är tillgängliga för programmiljöer.
...
> [!NOTE]
> De flesta av PowerBI.com-lösningarna i listan nedan har bäddats in i analytiska arbetsytor i tidigare versioner. Genom att använda analytiska arbetsytor tas behovet att hämta dessa lösningar från ett delat resursbibliotek i LCS bort. Avsnitten i den här listan anger var dessa PowerBI.com-lösningar har bäddats, där så är tillämpligt.

- [Utfall kontra budget](ledger-budgets-power-bi.md)
- [Kassaöversikt](../../../finance/cash-bank-management/Cash-Overview-Power-BI-content.md)
...
- [Hantering av kredit och inkasso](../../../finance/accounts-receivable/credit-collections-power-bi.md)
...
- [Hantering av anläggningstillgångar](../../../finance/fixed-assets/Fixed-asset-management-workspace.md)
...
- [Leverantörsbetalningar](../../../finance/accounts-payable/Vendor-payments-workspace.md)
