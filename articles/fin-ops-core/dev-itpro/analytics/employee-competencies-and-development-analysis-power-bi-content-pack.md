...
description: Den här artikeln beskriver Power BI-innehåll för medarbetarkompetenser och utveckling.
author: jcart1106
ms.date: 12/19/2017
ms.topic: article
ms.prod: ''
...
Den här artikeln beskriver Power BI-innehåll för medarbetarkompetenser och utveckling. 
...
Programdata används för att fylla i rapporter i innehållspaketet för medarbetares kompetenser och utveckling. Följande tabell visar enheterna som innehållspaketet baserades på.
