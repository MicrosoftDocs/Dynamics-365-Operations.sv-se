...
description: I den här artikeln beskrivs hur du konfigurerar olika egenskaper för en manuell uppgift.
author: ChrisGarty
ms.date: 08/23/2017
ms.topic: article
ms.prod: ''
...
I den här artikeln beskrivs hur du konfigurerar olika egenskaper för en manuell uppgift.
