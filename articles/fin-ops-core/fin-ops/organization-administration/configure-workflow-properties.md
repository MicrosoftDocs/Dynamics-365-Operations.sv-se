...
description: I den här artikeln beskrivs hur du konfigurerar olika egenskaper för ett arbetsflöde.
author: ChrisGarty
ms.date: 07/07/2020
ms.topic: article
ms.prod: ''
...
I den här artikeln beskrivs hur du konfigurerar olika egenskaper för ett arbetsflöde.
