...
description: Den här artikeln hänvisar till resurser som hjälper dig i din organisation.
author: sericks007
ms.date: 08/18/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8882061"
---
# <a name="organization-administration-home-page"></a>Organisationsadministration – startsida

[!include [banner](../includes/banner.md)]

Den här artikeln innehållet som hjälper privilegierade användare och administratörer att konfigurera systemet så att det arbetar snabbt och effektivt inom din organisation eller företag.
