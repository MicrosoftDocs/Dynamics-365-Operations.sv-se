...
description: I den här artikeln beskrivs hur du konfigurerar olika egenskaper för ett manuellt beslut.
author: ChrisGarty
ms.date: 06/15/2020
ms.topic: article
ms.prod: ''
...
I den här artikeln beskrivs hur du konfigurerar olika egenskaper för ett manuellt beslut.
