---
title: Planera för den globala adressboken och andra adressböcker
description: Den här artikeln ger en beskrivning av övervägandena och besluten som måste fattas under planeringsprocessen.
author: msftbrking
ms.date: 01/13/2020
ms.topic: article
ms.prod: ''
