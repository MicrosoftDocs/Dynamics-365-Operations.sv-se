...
description: Denna artikel anger nya eller uppdaterade uppgiftsguider som släpptes för Microsoft APQC Unified Library för Microsoft Dynamics 365 for Operations (november 2016 - alla språk). Inge nytt Komma igång-biblioteket gavs ut.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Denna artikel anger nya eller uppdaterade uppgiftsguider som släpptes för Microsoft APQC Unified Library för Microsoft Dynamics 365 for Operations (november 2016 - alla språk). Inge nytt Komma igång-biblioteket gavs ut.
...
| BPM-rad                                                                                           | Land/region |
|----------------------------------------------------------------------------------------------------|----------------|
| Huvudfakturadata i AP-system med hjälp av godkännandejournal                                               | Globalt         |
| Huvudfakturadata i AP-system med hjälp av leverantörsfakturan (Ange och bokför en leverantörsfaktura med matchning) | Globalt         |
...
| Registrera inleverans för leverantörsfaktura och matcha den mot inlevererad kvantitet                           | Globalt         |
...
| Beräkna ränta och skapa och skriv ut och bokför räntefakturor (beräkna ränta) | Globalt         |
| Skapa en kravbrevsserie                                                | Globalt         |
| Skapa ett autogiromedgivande för en kund.                                       | Globalt         |
| Skapa en fritextfaktura                                                         | Globalt         |
...
### <a name="address-book"></a>Adressbok
...
| BPM-rad                    | Land/region |
|-----------------------------|----------------|
| Ändra en budgetplanlayout | Globalt         |

### <a name="cash-management"></a>Likviditetsförvaltning
...
| Översikt över leverantörsbetalningar                                             | Globalt         |
...
| BPM-rad             | Land/region |
|----------------------|----------------|
| Skapa kostnadselement | Globalt         |
| Skapa kostnadsobjekt  | Globalt         |
...
| \*Kontinuitetskontroll för kinesisk verifikation                                                                                               | Kina                             |
| \*CN-00010 Kinesisk hierarki för kontoplan                                                                                  | Kina                             |
| \*CN-00016 Användaråtgärdslogg efter kinesiska arbetsregler                                                                              | Kina                             |
| \*Inställningar för export av Golden Tax-integrering                                                                                            | Kina                             |
| \*Bokför verifikationer från andra moduler, som försäljningsfakturor                                                                          | Kina                             |
| \*Bokför verifikationer från den allmänna journalen                                                                                         | Kina                             |
| \*Skapa grundläggande momsintegrationsprofil för Kina                                                                                 | Kina                             |
| \*Skapa kinesiska verifikationer                                                                                                        | Kina                             |
...
| DK-00007 FIK 752 gireringsblankett/Bokför fritextfaktura med en betalningsblankett                                           | Danmark                           |
| DK-00007 FIK 752 gireringsblankett/Bokför projektfaktura med en betalningsblankett                                             | Danmark                           |
...
| \*EEU-00047 Förskottsbetalning till medarbetare                                                                                          | Östeuropa                    |
...
| \*EE-00015 Verktyg för generering av betalningsreferens                                                                                     | Europa                            |
| EUR-00002 Generera en Intrastat-deklaration för EU                                                                                   | Europa                            |
| \*EUR-00002 Ange en fraktadress för en inomeuropeisk transaktion                                                          | Europa                            |
...
| \*EUR-00015 Partsökning via moms-ID                                                                                            | Europa                            |
| \*EUR-00015 Registrering av moms-ID för leverantör                                                                                        | Europa                            |
| \*EUR-00015 Skapa moms-ID                                                                                                        | Europa                            |
| \*HU-00001 Beräkning av valutakurs                                                                                             | Europa                            |
| Importera konfiguration av ISO20022-kreditöverföring                                                                                    | Europa                            |
| Importera konfiguration för ISO20022-autogiro                                                                                       | Europa                            |
| \*LT-00003 Överföringsdokumentet för transport av varor inom företaget/Generera ett dokument för överföring för en intern lageröverföring   | Europa                            |
| \*LT-00003 Överföringsdokumentet för transport av varor inom företaget/Ställ in överföringsdokumenten för transport av varor inom ett företag | Europa                            |
| \*NO-00002 Kundbetalning baserat på betalnings-ID                                                                                  | Europa                            |
| Ställ in företagets bankkonton för ISO20022-kreditöverföringar                                                                       | Europa                            |
| Ställ in företagets bankkonton för ISO20022-autogiron                                                                          | Europa                            |
| Ställ in kunder och kundbankkonton för ISO20022-autogiron                                                           | Europa                            |
| Ställ in en betalningsmetod för ISO20022-kreditöverföringar                                                                            | Europa                            |
| Ställ in en betalningsmetod för ISO20022-autogiro                                                                               | Europa                            |
| Ställ in leverantörer och leverantörsbankkonton för ISO20022-krediteringsöverföringar                                                            | Europa                            |
| Upprätta betalningsmetoder för kunder                                                                                            | Frankrike                            |
| FR-00002 Kund- och leverantörskonto                                                                                             | Frankrike                            |
| FR-00003 NAF-koder och SIRET-nummer                                                                                             | Frankrike                            |
| FR-00004 Godkänna och bokföra utställda växlar                                                                                  | Frankrike                            |
| FR-00004 Franska växlar och skuldsedlar                                                                           | Frankrike                            |
...
| FR-00004 Uppdatera betalningsmetod för kund                                                                                    | Frankrike                            |
...
| ER Designa domänspecifik datamodell (november 2016)                                                                             | Tyskland                           |
| ER importera en konfiguration från Lifecycle Services                                                                                | Tyskland                           |
| ER överför en konfiguration till Lifecycle Services                                                                                | Tyskland                           |
| ER Använd dokumenthanteringsfiler i formatutmatningar (Del 1: Förbered datamodellen)                                                  | Tyskland                           |
| ER Använd dokumenthanteringsfiler i formatutmatningar (Del 2: Utöka datamodellen)                                                   | Tyskland                           |
| ER Använd dokumenthanteringsfiler i formatutmatningar (Del 3: Skapa format)                                                       | Tyskland                           |
| ER Använd dokumenthanteringsfiler i formatutmatningar (Del 4: Kör format)                                                          | Tyskland                           |
| ER Använd dokumenthanteringsfiler i formatutmatningar (Del 5: ändra och kör format)                                               | Tyskland                           |
| ER Använd ekonomiska dimensioner som en datakälla (Del 1: Designa datamodell)                                                         | Tyskland                           |
| ER Använd ekonomiska dimensioner som en datakälla (Del 2: Modellmappning)                                                             | Tyskland                           |
| ER Använd ekonomiska dimensioner som en datakälla (Del 3: Designa rapporten)                                                         | Tyskland                           |
...
| \*EUR-00018 Momsavstämningsrapport                                                                                            | Island                           |
...
| Konfigurera en avskrivningsprofil och en bokföringsprofil för ytterligare avskrivning                                               | Japan                             |
| Konfigurera en avskrivningsprofil och en bokföringsprofil för specialavskrivning                                                  | Japan                             |
...
| Skapa accelererad avskrivningsprofil och tilldela den till räkenskapsboken                                                                    | Japan                             |
| Skapa ett accelererat avskrivningsdokument och ange användningsdata                                                                 | Japan                             |
| Skapa och tilldela en utrustningsgrupp                                                                                             | Japan                             |
...
| JP-00011 Konsoliderad faktura - KR – Skapa och bekräfta konsoliderad kundfaktura                                          | Japan                             |
| JP-00027 Formulär 26 för avskrivbar momsdeklaration                                                                                 | Japan                             |
| Underhålla avdragsgilla anläggningstillgångar huvuddatafiler för utgifter                                                                   | Japan                             |
...
| Ställ in rapport för japansk konsumtionsskatt                                                                                               | Japan                             |
...
| MX-00020: Producera mexikansk elektronisk redovisningsrapport version 1.1                                                        | Mexiko                            |
...
| BPM-rad                                                  | Land/region |
|-----------------------------------------------------------|----------------|
| Beräkna avskrivning av anläggningstillgången över juridiska personer  | Globalt         |
| Ändra tillgångsgrupp                                        | Globalt         |
...
| Omklassificera anläggningstillgångar                                   | Globalt         |
| Ställ in en förteckning över anläggningstillgångar                                 | Globalt         |
...
| Underhåll mallar för ekonomisk dimension         | Globalt         |
| Stängning av massräkenskapsperiod                    | Globalt         |
| Bearbeta poster i redovisningsjournal                        | Globalt         |
...
### <a name="inbound-consignment"></a>Inkommande försändelse

| BPM-rad                                                                   | Land/region |
|----------------------------------------------------------------------------|----------------|
| \*Ändra ägarskapet för försändelselagret baserat på produktionsbegäran | Globalt         |
| \*Skapa en ny order för lagerpåfyllnad för försändelse                                 | Globalt         |
| \*Övervaka försändelselagret med hjälp av leverantörssamarbete                 | Globalt         |
...
| BPM-rad                                  | Land/region |
|-------------------------------------------|----------------|
| Skapa en koncernintern plan               | Globalt         |
| Visa utgående planerad koncernintern efterfrågan | Globalt         |

### <a name="performance-management"></a>Prestationshantering

| BPM-rad                                                     | Land/region |
|--------------------------------------------------------------|----------------|
| \*Lägg till i din resultatjournal och skicka beröm till någon | Globalt         |
| \*Skapa ett mål                                              | Globalt         |
| \*Skapa en resultatöversyn                                | Globalt         |
...
| BPM-rad                                                               | Land/region |
|------------------------------------------------------------------------|----------------|
| Lägg till en bild till en produkt                                              | Globalt         |
| Klassificera en produkt med hjälp av kategorihierarkier                          | Globalt         |
| Skapa en streckkod för en produkt                                        | Globalt         |
| \*Skapa en produktnummernomenklatur för fördefinierade produktvarianter | Globalt         |
| \*Skapa en produktnummernomenklatur för konfigurerade produktvarianter | Globalt         |
| \* Definiera standardorderinställningar för en artikel.                            | Globalt         |
| Skapa en försäljningsorder för en konfigurerbar produkt                        | Globalt         |
| Skapa urvalskriterier för försäljningspris                                  | Globalt         |
| Ange GTIN-kod för en produkt                                      | Globalt         |
...
| BPM-rad                                              | Land/region |
|-------------------------------------------------------|----------------|
| Lägg till en föregångare till en produktionsflödesaktivitet       | Globalt         |
| Lägg till en befintlig aktivitet på en produktionsflödesversion | Globalt         |
| Inaktivera en produktionsflödesversion                  | Globalt         |
| Definiera ett utgångsdatum för en produktionsflödesversion   | Globalt         |
...
| Kontrollera åtkomsten till inköpsavtal från offentliga sektorn                      | Globalt         |
| Skapa en faktureringsklassificering                                               | Globalt         |
| Skapa en faktureringskod                                                         | Globalt         |
| Skapa en utfästelse för att reservera budgetmedel till offentliga sektorn                 | Globalt         |
| Skapa ett anpassat fält för en faktureringskod                                      | Globalt         |
| Skapa en fondtyp                                                            | Globalt         |
| Skapa en engångsleverantör och faktura                                          | Globalt         |
...
| Skapa en avancerad redovisningspost i den offentliga sektorn                          | Globalt         |
| Skapa en ursprunglig budget och återför sedan preliminära budgetposter         | Globalt         |
| Skapa och tilldela en handelspartnerskod i den offentliga sektorn                 | Globalt         |
...
| Ställa in en härledd ekonomisk hierarki i den offentliga sektorn                     | Globalt         |
| Ställa in en fond i offentliga sektorn                                            | Globalt         |
...
| BPM-rad                                                       | Land/region |
|----------------------------------------------------------------|----------------|
| Konfigurera en arbetare                                             | Globalt         |
| \*Konfigurera maskininlärningsdrivna produktrekommendationer   | Globalt         |
| Konfigurera funktionsprofilen för en säljare | Globalt         |
| \*Skapa en visuell butiksprofil (november 2016)                  | Globalt         |
| Skapa och associera register                                 | Globalt         |
| Skapa kundtjänstorder                                      | Globalt         |
| Skapa handelsavtal med hjälp av en kategoriprissättningsregel          | Globalt         |
| Skapa, beräkna och bokföra ett utdrag för en butik            | Globalt         |
| Definiera en anknytning och tilldela en rabatt                    | Globalt         |
| Definiera och hantera kassabehörighetsgrupper                        | Globalt         |
| Definiera kontinuitetstidsplan                                     | Globalt         |
| \*Definiera butikskanalkommunikationer (CDX)                   | Globalt         |
| Justeringar av lojalitetsbelöningar                                    | Globalt         |
| Hantera butikssortiment                                             | Globalt         |
| Momstilldelning och åsidosättning                              | Globalt         |
| Ställ in regler och parametrar för direktleverans och centraliserad distribution | Globalt         |
| Använda kontinuitetsprogram                                       | Globalt         |
...
### <a name="supply-relationship-management"></a>Hantering av leveransrelationer
...
| BPM-rad                                                                    | Land/region |
|-----------------------------------------------------------------------------|----------------|
| Skapa en platsprofil                                                   | Globalt         |
| \*Skapa ett nytt menyalternativ för mobila enheter för avstämning av ID-nummer          | Globalt         |
| Stäm av fraktsedel manuellt                                                  | Globalt         |
| Registrera en förares incheckning och utcheckning för ett möte                   | Globalt         |
| Ställ in ett menyalternativ för mobila enheter för att utföra arbete av typen Inköpsorder | Globalt         |
| Skapa ett möte för en beläggning                                            | Globalt         |
| Ställa in ett transportanbud                                              | Globalt         |
| Ställ in automatisk fraktavstämning                                     | Globalt         |
| \*Skapa omallokering av artiklar för kort plockning                                    | Globalt         |
