...
1. Öppna **Butik \> Kanalinställningar \> Kassainställningar \> Kassaprofiler \> Funktionsprofiler** och välj en funktionsprofil som är kopplad till butikerna du vill göra förbättringar för kassahantering tillgänglig.
...
3. För att ställa in kassaskåp, gå till **Butik \> Kanaler \> Butiker \> Alla butiker** och välj en butik.
...
- När en användare väljer att stänga ett skift, validerar Retail att det inte finns några ej avstämda kassahanteringstransaktioner i skiftet. Användare kan inte stänga ett skift om det finns ej avstämda transaktioner.
