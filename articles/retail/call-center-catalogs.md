...
description: Det här avsnittet innehåller en beskrivning av den callcenterspecifika funktionen för kataloger i Dynamics 365 Retail.
author: josaw1
manager: AnnBe
ms.date: 05/15/2018
ms.topic: article
