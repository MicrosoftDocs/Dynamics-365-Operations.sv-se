...
# <a name="set-up-and-manage-images-for-retail-modern-pos-mpos"></a>Ställ in och hantera bilder för Retail Modern POS (MPOS)
...
3.  På **Mediesökväg** snabbfliken anger du den återstående sökvägen till bildplatsen. Mediesökvägen stöder **LanguageID** som en variabel. För demodatan kan du exempelvis skapa en mapp kallad **Katalogen** för alla katalogbilder under URL:en för mediabas för din mediaserver (https://testax3ret.cloud.test.dynamics.com/RetailServer/MediaServer). Du kan sedan ha en mapp för varje språk, till exempel en-US eller fr-FR och kopiering lämpliga bilderna under varje mapp. Om du inte har olika bilder för olika språk, kan du utesluta **LanguageID** variabeln i din mappstruktur, och peka direkt till katalogmappen, som innehåller katalogbilder. **Notering:** Den aktuella versionen av Dynamics 365 for Retail stöder **{LanguageId}** token för katalog-, produkt- och kategorienheter. (**{LanguageID}** token stöds inte för kund- och arbetarenheter, enligt den befintliga standard som har varit gällande sedan Microsoft Dynamics AX 6.x.)
...
4.  Klicka på **Skapa** på snabbfliken **Skapa bild-URL för Excel**. **Viktigt:** Så snart mediamallen ändras, måste du klicka på **Skapa** innan du kan använda Redigera i Excel-funktionen. [![excel1](./media/excel1.jpg)](./media/excel1.jpg) Du ser nu en förhandsgranskning av bild-webbadresserna som har skapats utifrån den senast sparade mediamallen. [![excel2](./media/excel2.png)](./media/excel2.png) **Obs!** De webbadresser som skapas för Excel använder sökvägen och konventionerna i den definierade mediamallen. Dessa inkluderar konventioner för filnamn. Förväntan är att du har ställt in de fysiska bilderna utanför Dynamics 365 for Retail och bilderna kan hämtas från URL som härleds från mediamallen, som du tidigare definierade. Du kan skriva över härledda URL genom att använda Redigera i Excel-funktionen.
