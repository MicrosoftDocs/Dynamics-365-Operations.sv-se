...
description: Det här ämnet innehåller en översikt betalningar i flera kanaler i Dynamics 365 Retail.
author: rubendel
manager: AnnBe
ms.date: 05/12/2019
ms.topic: article
...
ms.locfileid: "2017584"
---
# <a name="omni-channel-payments-overview"></a>Översikt över betalningar i flera kanaler

[!include [banner](../includes/banner.md)]

Det här ämnet innehåller en översikt betalningar i flera kanaler i Dynamics 365 Retail. Den innehåller en omfattande lista över scenarier som stöds, information om funktioner, inställningar och fel sökning samt beskrivningar av några vanliga problem.
...
Betalnings-SDK bygger på två uppsättningar API (application programming interfaces). en första uppsättningen med API:er **iPaymentProcessor**. Det används för att implementera "Kortet är tillgängligt" betalningsanslutningar om kan användas i samtalsgrupper och med Microsoft Dynamics näthandelsplattformen. För mer information om gränssnittet **iPaymentProcessor**, se [Implementera en betalningsanslutningar och betalningsenhet](https://download.microsoft.com/download/4/D/7/4D7C6B05-0C23-4C6C-BA13-AB62ED08AA61/The%20Guide%20to%20Implementing%20Payment%20Connector%20and%20Payment%20Device.docx) vitbok, som täcker betalningar. 
...
- **Konfiguration av betalningar i flera kanaler** I backoffice, gå till **Retail \> Administrationsinställning \> Parametrar \> Gemensamma butiksparametrar**. sedan på fliken **Betalningar i flera kanaler** anger du alternativet **Använd betalningar i flera kanaler** till **Ja**.
...
- Alternativet **Betalningar i flera kanaler** på sidan **Gemensamma butiksparametrar** är inställt på **Sant**.
...
3. I Retail använder du batchjobbet **Synkronisera order** och distributionsschema **P-001** för att skapa order i backoffice.
...
1. I Retail, på sidan **Kundtjänst** anger du **Karen Berg** i sökfältet och väljer sedan **Sök**. 
