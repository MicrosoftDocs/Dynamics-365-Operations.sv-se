...
- Dra in transaktionsdata för online-butik i huvudkontor.
- Synkronisera order för att skapa försäljningsorder i huvudkontor.

Du kan dra in butikstransaktionsdata online manuellt genom att köra P-jobbet eller genom att skapa ett återkommande batchjobb.

### <a name="manually-running-the-p-job"></a>Köra P-jobbet manuellt

1. Gå till Alla arbetsytor > Butikens IT.
