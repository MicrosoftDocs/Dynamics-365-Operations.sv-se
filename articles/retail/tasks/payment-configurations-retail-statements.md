...
---
# <a name="configure-payment-method-settings-that-affect-retail-statements"></a>Konfigurera inställningarna för betalningsmetod som påverkar detaljhandelsutdrag
