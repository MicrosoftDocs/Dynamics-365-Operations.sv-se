...
Mer information om de inställningar som krävs för Sverige finns i [ställa in Retail för Sverige](./emea-swe-cash-registers.md#setting-up-retail-for-sweden).
...
5. Hitta och ta bort det tidigare Hardware Station-tillägget från konfigurationsfilen för tillägget.
    ...
    # <a name="retail-73-and-earliertabretail-7-3"></a>[Retail 7.3 och tidigare](#tab/retail-7-3)

    ``` xml
    <add source="assembly" value="Contoso.Commerce.HardwareStation.Extension.FiscalRegisterSample" />
    ```

    # <a name="retail-731-and-latertabretail-7-3-1"></a>[Retail 7.3.1 och senare](#tab/retail-7-3-1)

    ``` xml
    <add source="assembly" value="Contoso.Commerce.HardwareStation.Extension.FiscalRegisterSample" />
    ```

    # <a name="retail-100-and-latertabretail-10-0"></a>[Retail 10.0 och senare](#tab/retail-10-0)
