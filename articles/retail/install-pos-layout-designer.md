...
-   Programmet startar inte, och du uppmanas att kontakta leverantören. **Lösning:** Lägg till webbadressen (URL) för Dynamics 365 for Retail till dina betrodda webbplatser i Internet Explorer. Klick på **Inställning** &gt; **Alternativ** &gt; **Säkerhet** &gt; **Säkra platser** &gt; **Platser** &gt; **Lägg till**.
