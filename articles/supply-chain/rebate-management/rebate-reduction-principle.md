---
title: Principer för rabattavdrag
description: I denna artikel beskrivs hur du konfigurerar principer för reducering. Principer för reducering styr beteendet när flera rabatter gäller för samma artikel eller transaktion.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
