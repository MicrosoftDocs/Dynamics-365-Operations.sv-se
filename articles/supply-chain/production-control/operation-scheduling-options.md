...
description: I denna artikel beskrivs alternativen för grovplanering. Du kan använda grovplaneringen för att ange en allmän uppskattning av produktionsprocessen över en viss tid.
...
ms.locfileid: "8907273"
---
# <a name="operations-scheduling-options"></a>Tidsplansalternativ för åtgärder

[!include [banner](../includes/banner.md)]

I denna artikel beskrivs alternativen för grovplanering. Du kan använda grovplaneringen för att ange en allmän uppskattning av produktionsprocessen över en viss tid.
