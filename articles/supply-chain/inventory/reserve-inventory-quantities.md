...
description: I denna artikel beskrivs de olika alternativ som är tillgängliga för att reservera lager.
author: yufeihuang
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
I denna artikel beskrivs de olika alternativ som är tillgängliga för att reservera lager.
