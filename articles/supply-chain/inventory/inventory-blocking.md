...
## <a name="disable-expected-receipts-from-quality-orders-that-sample-blocked-inventory"></a>Inaktivera förväntade inleveranser från kvalitetsorder som ger exempel på blockerat lager
