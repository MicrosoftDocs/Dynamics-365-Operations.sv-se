...
description: I denna artikel beskrivs hur du kan använda artikelspårning för att identifiera var artiklar och råmaterial har använts, används eller ska användas i produktionen och försäljningsprocessen.
author: yufeihuang
ms.date: 11/02/2017
ms.topic: article
ms.prod: ''
...
I denna artikel beskrivs hur du kan använda artikelspårning för att identifiera var artiklar och råmaterial har använts, används eller ska användas i produktionen och försäljningsprocessen.
