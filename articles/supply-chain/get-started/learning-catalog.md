...
:::row:::
    ...
    [Behandling](learning-catalog-developer.md#servicing)

    [Migrering och uppgradering](learning-catalog-developer.md#migration-and-upgrade)

    [Testar](learning-catalog-developer.md#testing)

    [Prov](learning-catalog-developer.md#exam)
...
:::row:::
    ...
    [Prov](learning-catalog-solution-architect.md#exam)
