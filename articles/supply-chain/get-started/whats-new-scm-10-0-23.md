...
| Försäljning och marknadsföring | Rensa försäljningsorderns uppdateringshistorik | Med hjälp av den här funktionen kan du rensa tillfälliga historiska poster som är relaterade till försäljningsorder uppdateringar. Den lägger till en ny knapp, som kallas **Rensa upp försäljningsuppdateringshistorik**, i åtgärdsfönstret för detalj- och listsidorna för försäljningsorder. |
