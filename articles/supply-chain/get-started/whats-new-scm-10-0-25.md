...
| Anskaffning och källa | Inaktivera återställningsknappen för inköpsrekvisitionsdistribution | Den här funktionen inaktiverar knappen **Återställ** på sidan **Redovisningsfördelning** för inköpsrekvisitioner som granskas. |
...
| Warehouse management | Inaktivera förväntade inleveranser från kvalitetsorder som ger exempel på blockerat lager | Den här funktionen förhindrar att systemet skapar förväntade inleveranstransaktioner för kvalitetsorder som exempel på lager med spärrstatus. Eftersom det inte finns någon tillgänglig lagerspärr tar den här funktionen bort förväntade inleveranser. Då ser du till att lagret inte slutar med flera spärrstatusar, vilket kan leda till problem med dataintegriteten. |
...
| --- | --- | --- |
| Tillgångshantering | Tillämpa regler för gruppering av arbetsorder medan en underhållsplan körs | Allmänt tillgängligt |
| Tillgångshantering | Räknarbaserade underhållsförbättringar | Allmänt tillgängligt |
| Kostnadshantering | Kostnadsberäkningsnivå | Allmänt tillgängligt |
...
| Kostnadshantering | Information om lagerstängningsförlopp | Allmänt tillgängligt |
| Kostnadshantering | Alternativ för att använda ekonomiska standarddimensioner som standard för omvärdering av standardkostnad för lager | Allmänt tillgängligt |
| Kostnadshantering | Lagervärderapport, datarensning | På som standard |
| Kostnadshantering | Lagring av lagervärderapport | På som standard |
| Kostnadshantering | Visa lagerstängningslogg i rutnät | På som standard |
| Konstruktionsändringshantering | Aktivera ändringshantering för befintliga produkter | På som standard |
| Konstruktionsändringshantering | Konstruktionsändringshantering | På som standard |
| Konstruktionsändringshantering | Konstruktionsmeddelanden för produktion | På som standard |
| Konstruktionsändringshantering | Förbättrat attributarv för konstruktionsändringshantering | På som standard |
| Konstruktionsändringshantering | Hantera formeländringar och deras ingredienser | På som standard |
| Konstruktionsändringshantering | Kontroller av produktberedskap | På som standard |
| Konstruktionsändringshantering | Variantgenerering för tekniska produkter | På som standard |
| Hantering av lager och lagerstyrning | Navigera till strukturlisteversion från strukturlisterader | Obligatoriskt |
| Huvudplanering | Batchbar bekräftelse och konsolidering för planerade bulk- och paketbatchorder | Allmänt tillgängligt |
...
| Huvudplanering | Prognosmodellval på Detaljer för efterfrågeprognos | Obligatoriskt |
| Huvudplanering | Visualisering av huvudplaneringsförlopp | Obligatoriskt |
| Huvudplanering | Parallell bekräftelse av planerade order | Obligatoriskt |
| Huvudplanering | Bekräfta planerad order med filtrering | På som standard |
| Huvudplanering | Sparade vyer för planerade order | På som standard |
| Anskaffning och källa | Inaktivera återställningsknappen för inköpsrekvisitionsdistribution | Allmänt tillgängligt |
| Anskaffning och källa | Aktivera återställning av anskaffningsrelaterade arbetsflöden | Allmänt tillgängligt |
...
| Anskaffning och källa | Tillåt leverantörer att ansöka om anskaffningskategorier via leverantörssamarbete | På som standard |
...
| Anskaffning och källa | Ansvarig part för inköpsavtal | På som standard |
| Anskaffning och källa | Sparade vyer för inköpsorder | På som standard |
| Produktinformationshantering | Strikt validering av standardkvantiteter för order | Obligatoriskt |
...
| Produktinformationshantering | Förbättringar av sidan med variantförslag | På som standard |
...
| Produktionskontroll | Aktivera automatisk generering av ID-nummer när rapportering slutförts i jobbkortenheten | Obligatoriskt |
...
| Produktionskontroll | Funktion för att låsa jobbkortsenhet och jobbkortsterminal för att anpassas till språk | Obligatoriskt |
| Produktionskontroll | Förbättringar av dialogrutorna Godkänn jobb och Överför jobb | Obligatoriskt |
| Produktionskontroll | ID-nummer för rapportering som färdig har lagts till på jobbkortenheten | Obligatoriskt |
| Produktionskontroll | Skriv ut etikett från jobbkortenhet | Obligatoriskt |
| Produktionskontroll | Produktionsgolvskörning | Obligatoriskt |
| Produktionskontroll | Funktionen för tillgångshantering för körningsgränssnittet för produktionsgolvet | På som standard |
| Produktionskontroll | Jobbsökning för produktionsgolvets körningsgränssnitt | På som standard |
| Produktionskontroll | Åsidosätta standardproduktionsreservation | På som standard |
| Produktionskontroll | Visa fullständiga serienummer, batch- och ID-nummer i gränssnittet för produktionsgolvkörning | På som standard |
| Försäljning och marknadsföring | Prestandaförbättringar för försäljningsorderinformation | Allmänt tillgängligt |
...
| Försäljning och marknadsföring | Raderingspolicy för försäljningsorder till inköpsorderrad | Obligatoriskt |
| Försäljning och marknadsföring | Dataexportpolicy som refereras i försäljningsoffert | Obligatoriskt |
| Försäljning och marknadsföring | Optimering av kontaktpersons datatabellsexport | På som standard |
...
| Försäljning och marknadsföring | Förbättra rapportresultat för de 100 främsta kunderna | På som standard |
| Försäljning och marknadsföring | Beräkna om uppskattat kundsaldo | På som standard |
| Försäljning och marknadsföring | Registrering av försäljningsreturorderrad med decimalprecision med och utan faktisk/nominell vikt | På som standard |
| Försäljning och marknadsföring | Sparade vyer för försäljning och marknadsföring | På som standard |
| Försäljning och marknadsföring | Bekräftelse av försäljningsorder med ett klick | På som standard |
| Warehouse management | Mallar för direktleverans med platsdirektiv | Allmänt tillgängligt |
| Warehouse management | Inaktivera förväntade inleveranser från kvalitetsorder som ger exempel på blockerat lager | Allmänt tillgängligt |
| Warehouse management | Inleveranshistorik för ID-nummer | Allmänt tillgängligt |
| Warehouse management | Avrunda kvantiteter neråt till närmaste försäljningsenhet vid frisläpp till lagerställe | Allmänt tillgängligt |
...
| Warehouse management | Använd snabbare API för behållare som stängs/öppnas igen på förpackningsstationen | Allmänt tillgängligt |
| Warehouse management | Validera mallar valda för lagerpåfyllnadsjobb | Allmänt tillgängligt |
...
| Warehouse management | Ändra lagerstatus för artiklar som styrs av spårningsdimensioner | Obligatoriskt |
| Warehouse management | Ändra arbetspool för arbete | Obligatoriskt |
| Warehouse management | Klusterposition full | Obligatoriskt |
| Warehouse management | Funktionen för klusterplats | Obligatoriskt |
| Warehouse management | Bekräfta och överföra | Obligatoriskt |
| Warehouse management | Bekräfta utgående leveranser från batchjobb | Obligatoriskt |
| Warehouse management | Kontrollera om en sammanfattningssida för inleverans ska visas på mobila enheter | Obligatoriskt |
| Warehouse management | Uppskjuten bearbetning av manuell åtgärd för lagerrörelse | Obligatoriskt |
...
| Warehouse management | Förbättrad layout för ID-nummeretikett | Obligatoriskt |
| Warehouse management | Utvärdera alla åtgärder för platsdirektiv för flera SKU:er | Obligatoriskt |
...
| Warehouse management | Placering för plats-ID-nummer | Obligatoriskt |
| Warehouse management | Blandning av produktstorlekar på plats | Obligatoriskt |
...
| Warehouse management | Förhindra att levererade ID-nummer för överföringsorder används på i andra distributionslager än måldistributionslagret | Obligatoriskt |
| Warehouse management | Prompt för att lösa tvetydiga plats/ID-nummernamn | Obligatoriskt |
| Warehouse management | Kvalitetskontroll | Obligatoriskt |
| Warehouse management | Användarinställningar, ikoner och stegrubriker för den nya distributionslagerappen | Obligatoriskt |
| Warehouse management | Ytterligare platszoner | På som standard |
| Warehouse management | Skapa och bearbeta överföringsorder från lagerställeappen | På som standard |
| Warehouse management | Aktivera snabbvalidering för lagerställets mobila enheter | På som standard |
| Warehouse management | Utnyttjande av artikelns konsolideringsplats | På som standard |
| Warehouse management | Maximal körningstid för jobbet Rensning av behållningsposter för lagerstyrning | På som standard |
| Warehouse management | Visualisering av utgående arbetsbelastning | På som standard |
| Warehouse management | Bearbeta lagerställeapphändelser | På som standard |
| Warehouse management | Sparad vy för workbench vid lastplanering | På som standard |
| Warehouse management | Sparad vy för sidan Information om arbete | På som standard |
| Warehouse management | Sparad vy för påfyllnadsbearbetning | På som standard |
| Warehouse management | Sparade vyer för lastbearbetning | På som standard |
| Warehouse management | Sparade vyer för leveransbearbetning | På som standard |
| Warehouse management | Information om påfyllnadsbatchjobb | På som standard |
| Warehouse management | Meddelanden för påfyllnadskörning | På som standard |
