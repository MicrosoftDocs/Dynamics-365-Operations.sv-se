...
description: Denna artikel innehåller en beskrivning av nya eller ändrade funktioner i Dynamics 365 Supply Chain Management 10.0.14.
author: kamaybac
ms.date: 08/31/2020
ms.topic: article
ms.prod: ''
...
Denna artikel anger nya eller ändrade funktioner i Microsoft Dynamics 365 Supply Chain Management version 10.0.14. Den här versionen har ett versionsnummer för 10.0.605 och är tillgänglig enligt följande:

- **Förhandsgranska utgåva:** september 2020
- **Allmän tillgänglighet (självuppdatering):** oktober 2020
- **Automatisk uppdatering:** november 2020

## <a name="features-included-in-this-release"></a>Funktioner som ingår i den här versionen

Den här versionen innehåller en uppdaterad plattform och allmänna förbättringar, men innehåller inga nya funktioner som är specifika för Supply Chain Management. Mer information om kommande funktioner finns på webbplatsen [utgivningsplaner](/dynamics365/release-plans/).

## <a name="additional-resources"></a>Ytterligare resurser

### <a name="platform-updates-for-finance-and-operations-apps"></a>Plattformsuppdatering för Ekonomi och drift-appar

Microsoft Dynamics 365 Supply Chain Management 10.0.14 inkluderar plattformsuppdateringar. Mer information finns i [Plattformsuppdateringar för version 10.0.14 av Ekonomi och Drift-appar (oktober 2020)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-14.md).

### <a name="bug-fixes"></a>Felkorrigeringar

Om du vill ha information om felkorrigeringar som ingår i varje uppdatering som ingår i 10.0.14 loggar du in på Lifecycle Services (LCS) och visar [KB-artikel](https://fix.lcs.dynamics.com/Issue/Details?bugId=488609&dbType=3&qc=8251e8e1d5e2386de850599926c1adc3fec8e2ba25308036d22cdfe0a1c28fc7).
