---
title: Nyheter och ändringar i Dynamics 365 Supply Chain Management (10.0.30 november 2022)
...
|---|---|---|---|
| Lager och logistik | [Spåra mjuka reserverade kvantiteter inom tilldelningar](/dynamics365-release-plan/2022wave2/finance-operations/dynamics365-supply-chain-management/track-soft-reserved-quantities-within-allocations) | [Lagerfördelning för Lagersynlighet](../inventory/inventory-visibility-allocation.md) |  Aktiveras via [tjänstekonfiguration](../inventory/inventory-visibility-configuration.md) |
