...
description: I denna artikel beskrivs de funktioner som gör att du kan köra en lagerföråldringsrapport och göra utdata tillgängliga som ett formulär och ett diagram.
author: JennySong-SH
ms.date: 11/11/2019
ms.topic: article
ms.prod: ''
