...
[BOM calculation by using a costing sheet](https://www.microsoft.com/download/details.aspx?id=101937) beskriver hur du ställer upp ett kostnadsredovisningsblad med material och tillverkning och hur inställningar påverkar resultat från strukturlisteberäkningar. För att bättre förstå artiklarna tillhandahålls konkreta scenarier och data som visar effekten av olika inställningar och konfigurationer.
