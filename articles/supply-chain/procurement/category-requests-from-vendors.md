...
Leverantören måste ha minst en samarbetsanvändare för leverantörer. Endast leverantörsanvändare som har en eller båda av följande säkerhetsroller kan skapa och skicka kategoribegäranden:

- Leverantörskontakt (extern)
- Leverantörsadmin (extern)
