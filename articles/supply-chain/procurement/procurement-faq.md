...
description: Denna artikel innehåller svar på vanliga frågor (FAQ) om anskaffningsfunktionen i Supply Chain Management
...
ms.locfileid: "8869587"
---
# <a name="procurement-faq"></a>Vanliga frågor och svar om anskaffning

[!include [banner](../includes/banner.md)]

Denna artikel innehåller svar på vanliga frågor (FAQ) om anskaffningsfunktionen i Supply Chain Management.
