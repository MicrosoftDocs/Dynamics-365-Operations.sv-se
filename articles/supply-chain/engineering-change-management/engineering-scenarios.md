...
## <a name="complete-the-change-order"></a>Slutföra ändringsordningen

Om du vill markera ändringsordningen som slutförd, vilket innebär att inga ytterligare åtgärder återstår, väljer du **Slutför** i åtgärdsfönstret.
