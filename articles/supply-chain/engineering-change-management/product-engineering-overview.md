...
Föregående video ([Ändra hanteringsfunktioner i Dynamics 365 Supply Chain Management](https://youtu.be/N313FqvRuBc)) finns med i [spellistan för ekonomi och drift](https://www.youtube.com/playlist?list=PLcakwueIHoT_SYfIaPGoOhloFoCXiUSyW) som finns på YouTube.
...
> [!NOTE]
> För att använda teknisk ändringshantering måste både stycklistnummersekvensen och formelnummersekvensen (om du använder formler) ställas in på *Automatisk* på sidan **Nummerserier**.
