...
Använd rutnätet på snabbfliken **attribut** om du vill ställa in de konstruktionsattribut som gäller för produkter som tillhör den här kategorin. För information om hur du skapar konstruktionsattribut, se [Konstruktionsattribut och sökning efter konstruktionsattribut](engineering-attributes-and-search.md).
