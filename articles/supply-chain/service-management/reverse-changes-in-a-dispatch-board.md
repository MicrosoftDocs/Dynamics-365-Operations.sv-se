...
2.  I formuläret **Utförseltavla** anger du relevant information i fälten och klickar sedan på **OK**. 

3.  Klicka på **Ångra** om du vill ångra eden senaste ändringen som inte sparats.

4.  Om du vill ångra en hel serie ändringar som inte har sparats fortsätter du att klicka på **Ångra** tills alla ändringar som du vill ångra har återkallats.
