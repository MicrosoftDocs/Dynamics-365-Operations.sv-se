...
description: I denna artikel beskrivs schemalagda arbetsorder för underhållsjobb i Tillgångshantering.
...
1. Klicka på **Tillgångshantering** > **Arbetsorder** > **Schemalagda arbetsorder för underhållsjobb**. En lista över alla arbetsorder som har ställts in på arbetsorderns livscykeltillstånd "schemalagd" eller "pågår" visas.
...
>[!NOTE]
>Läs mer om att schemalägga flera arbetsorder eller en arbetsorder i [Schemalägg arbetsorder](../work-order-scheduling/schedule-work-orders.md) och [Skicka arbetsorder](../work-order-scheduling/dispatch-work-order.md).
