...
description: Denna artikel beskriver hur du skapar tillgångstyper i Tillgångshantering. Det beskriver också de element som är relaterade till tillgångstyper.
...
9. Du kan också välja räknare som ska vara relaterade till tillgångstypen. På snabbfliken **räknare** gör du dina val med hjälp av metoderna som beskrivs för underhållsjobbtyper i steg 8. Mer information om hur du konfigurerar räknare finns i [räknare](counters.md).
...
> [!NOTE]
> Om du har många reservdelsrader och underhållsplaner som du ska återanvända, kan du med funktionen Kopiera snabbt och enkelt konfigurera data för många kombinationer av inställningar av tillgångstyp.
