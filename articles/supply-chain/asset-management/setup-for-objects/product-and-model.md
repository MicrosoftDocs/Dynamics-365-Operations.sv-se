...
8. I fältet **tillgångstyp** väljer du den tillgångstyp som tillverkarmodellen ska relateras till.
    ...
    > [!NOTE]
    > Du kan också ställa in relationer för tillgångstyper, tillverkare och modeller i sökningen **tillgångstyper**. Mer information finns i [Skapa en tillgångstyp](../setup-for-objects/object-types.md).
