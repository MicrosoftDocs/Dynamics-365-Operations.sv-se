...
## <a name="create-a-product-lifecycle-state"></a><span data-ttu-id="6d63a-108">Skapa ett produktlivscykeltillstånd</span><span class="sxs-lookup"><span data-stu-id="6d63a-108">Create a product lifecycle state</span></span>
1. <span data-ttu-id="6d63a-109">Gå till Produktinformationshantering > Inställningar > produktlivscykeltillstånd.</span><span class="sxs-lookup"><span data-stu-id="6d63a-109">Go to Product information management > Setup > Product lifecycle state.</span></span>
2. <span data-ttu-id="6d63a-110">Klicka på Ny.</span><span class="sxs-lookup"><span data-stu-id="6d63a-110">Click New.</span></span>
3. <span data-ttu-id="6d63a-111">Ange ett värde i fältet Tillstånd.</span><span class="sxs-lookup"><span data-stu-id="6d63a-111">In the State field, type a value.</span></span>
4. <span data-ttu-id="6d63a-112">Ange ett värde i fältet Beskrivning.</span><span class="sxs-lookup"><span data-stu-id="6d63a-112">In the Description field, type a value.</span></span>
