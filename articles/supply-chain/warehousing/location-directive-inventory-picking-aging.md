...
1. *Lagerställets platsstatus* version 10.0.29 är den här funktionen är obligatoriskt och kan inte inaktiveras. Mer information finns i [Lagerställets platsstatus](warehouse-location-status.md).
