...
description: Denna artikel beskriver hur uttags-kanban används för materialpåfyllnad för tillverkning.
author: perlynne
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863720"
---
# <a name="replenishment-with-withdrawal-kanbans"></a>Lagerpåfyllnad med uttags-kanbans

[!include [banner](../includes/banner.md)]

Denna artikel beskriver hur uttags-kanban används för materialpåfyllnad för tillverkning.
