---
title: Nyheter eller ändringar i mobilappen Warehouse Management
description: Denna artikel visar en lista med nya och ändrade funktioner för varje frisläppt version av mobilappen Warehouse Management för Microsoft Dynamics 365 Supply Chain Management.
author: Mirzaab
ms.date: 04/25/2022
ms.topic: article
...
- Lade till en användarinställning som låter medarbetarna välja var i programmet visar produkten (i både kort och stegrubriker, bara i stegrubriker eller inte alls). 
- Förbättrad detaljkortskärmens layout genom att minska storleken på stegbanderollen och kvantitetsinmatning, vilket lämnar mer plats för annat innehåll. 
- Förbättrade användargränssnittet när det körs på en Honeywell Thor-enhet. 
- Förbättrat helskärmsläge (gäller endast enheter med maskinvarutangentbord). 
- Förbättrade resultat vid sortering av detaljer för kort och anpassade sidor efter prioritet eller underprioritet (DataPriority eller DisplaySubPriority). 
- Stöd för fler språk har lagts till. 
- Förbättrad stabilitet. 
- Förbättrad flera bilder och ikoner. 

## <a name="version-20350"></a>Version 2.0.35.0

I den här versionen ingår följande nya funktioner, korrigeringar och förbättringar:
- Korrigerade ett problem i Android där programmet kraschade om sidan **Arbetslistan** öppnades när inga kort visades.
...
-   Förbättrat användargränssnitt som gör det snabbare och enklare att arbeta med långa urvalslistor. Arbetarna kan nu söka efter ett listobjekt med hjälp av namnet istället för att bläddra genom hela listan.
-   Korrigerat ett problem där förinskrivna värden inte skrivs över när du skannar med tecken.
...
- Förbättrad stabilitet.
- Introducerade möjligheten att fortsätta skanna även om feldialogrutan visas på skärmen.
- Lade till stöd för ASCII 10 i streckkoder.
- Förbättrade användarvänligheten hos stegvisa instruktionsdialogrutor.
- Åtgärdade ett problem där en tom skärm ibland kunder visas.
- Åtgärdade ett problem med att arbetslistor inte rullade korrekt när de kördes i Microsoft Windows.
...
- Förbättrad skannersida för att aktivera skanningsalternativet på **detaljsidor**.
- Förbättrad tryckning, till exempel för pekskärm.
- Förbättrade prestandaproblem för Android.
- Fast placering av flera rubriker för att tillåta att fler kort visas på sidan **Förfrågan**.
- Förbättrad rullning så att det blir mindre körsträcka för rullning av sidnumrering.
- Lade till långt tryck för att visa tilläggstext på sidan **Förfrågan**.
- Korrigerade information om saknat enhets-ID för Android.
- Ökad stabilitet.
- Optimerade inloggningslayouten.
- Lade till gesten svep-åt-höger för att stänga popup-dialogsidor på knappsatsen, sidan **Detaljerad information** och indatasidor.
