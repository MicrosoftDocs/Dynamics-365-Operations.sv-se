...
ms.locfileid: "4437431"
---
# <a name="consolidate-shipments-by-using-shipment-consolidation-policies"></a>Konsolidera leveranser genom att använda policyer för leveranskonsolidering

[!include [banner](../includes/banner.md)]

I följande scenarier beskrivs leveranskonsolideringsprocessen, där konsolideringspolicyer för leveranser används vid automatisk och manuellt släpp till lagerstället:
