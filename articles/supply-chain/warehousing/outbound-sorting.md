...
### <a name="set-up-a-wave-template"></a><span data-ttu-id="ed5c3-123">Ställa in en påfyllnadsmall</span><span class="sxs-lookup"><span data-stu-id="ed5c3-123">Set up a wave template</span></span>
...
1. <span data-ttu-id="ed5c3-139">På snabbfliken **Användare** väljer **Ny** för att skapa ett mobilenhetskonto och anger följande värden:</span><span class="sxs-lookup"><span data-stu-id="ed5c3-139">On the **Users** FastTab, select **New** to create a mobile device account, and set the following values for it:</span></span>
    ...
    - <span data-ttu-id="ed5c3-140">**Användar-ID:** Ange ett unikt ID.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-140">**User ID:** Enter a unique ID.</span></span>
...
1. <span data-ttu-id="ed5c3-158">Gå till **Lagerstyrning \> Inställningar \> Parametrar för lagerstyrning**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-158">Go to **Warehouse management \> Setup \> Warehouse management parameters**.</span></span>
...
1. <span data-ttu-id="ed5c3-174">Gå till **Lagerstyrning \> Inställningar \> Lagerställe \> Platser**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-174">Go to **Warehouse management \> Setup \> Warehouse \> Locations**.</span></span>
...
1. <span data-ttu-id="ed5c3-192">Ange följande värden på snabbfliken **Allmänt**:</span><span class="sxs-lookup"><span data-stu-id="ed5c3-192">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="ed5c3-210">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-210">Select **OK**.</span></span>
...
1. <span data-ttu-id="ed5c3-232">Välj **Spara**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-232">Select **Save**.</span></span>
...
1. <span data-ttu-id="ed5c3-251">Välj **Spara**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-251">Select **Save**.</span></span>
...
1. <span data-ttu-id="ed5c3-268">Välj **Spara**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-268">Select **Save**.</span></span>
...
1. <span data-ttu-id="ed5c3-285">Gå till **Lagerstyrning \> Inställningar \> Mobil enhet \> Meny på mobil enhet**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-285">Go to **Warehouse management \> Setup \> Mobile device \> Mobile device menu**.</span></span>
...
1. <span data-ttu-id="ed5c3-300">I rubriken anger du följande värden:</span><span class="sxs-lookup"><span data-stu-id="ed5c3-300">In the header, set the following values:</span></span>
    ...
    - <span data-ttu-id="ed5c3-301">**Sekvens:** *1*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-301">**Sequence:** *1*</span></span>
...
#### <a name="set-up-a-multiple-sku-directive"></a><span data-ttu-id="ed5c3-324">Ställa in flera SKU-direktiv</span><span class="sxs-lookup"><span data-stu-id="ed5c3-324">Set up a multiple-SKU directive</span></span>
...
1. <span data-ttu-id="ed5c3-343">På snabbfliken **Platsdirektivåtgärder** välj **Ny** och ange sedan följande värden på den nya raden.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-343">On the **Location Directive Actions** FastTab, select **New**, and then set the following values on the new line.</span></span> <span data-ttu-id="ed5c3-344">Acceptera standardvärden i alla andra fält.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-344">Accept the default values for all the other fields.</span></span>
    ...
    - <span data-ttu-id="ed5c3-345">**Sekvens:** *1*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-345">**Sequence:** *1*</span></span>
...
1. <span data-ttu-id="ed5c3-361">På snabbfliken **Arbetsmallinformation** välj **Ny** för att lägga till en rad och anger sedan följande värden:</span><span class="sxs-lookup"><span data-stu-id="ed5c3-361">On the **Work Template Details** FastTab, select **New** to add a line, and then set the following values for it:</span></span>
    ...
    - <span data-ttu-id="ed5c3-362">**Arbetstyp:** *plockning*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-362">**Work type:** *Pick*</span></span>
...
1. <span data-ttu-id="ed5c3-378">Välj **OK** för att stänga dialogrutan.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-378">Select **OK** to close the dialog box.</span></span>
...
1. <span data-ttu-id="ed5c3-396">Gå till **Försäljning och marknadsföring \> Försäljningsorder \> Alla försäljningsorder**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-396">Go to **Sales and marketing \> Sales orders \> All sales orders**.</span></span>
...
1. <span data-ttu-id="ed5c3-418">På sidan **Reservation** välj **Reservera parti** för att reservera den valda radens fullständiga kvantitet i lagerstället.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-418">On the **Reservation** page, select **Reserve lot** to reserve the full quantity of the selected line in the warehouse.</span></span>
...
1. <span data-ttu-id="ed5c3-436">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-436">Select **OK**.</span></span>
...
1. <span data-ttu-id="ed5c3-455">I fältet **ID** anger du det arbets-ID som skapades för försäljningsorder 2 där rad 2 har artikel *A0002*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-455">In the **ID** field, enter the work ID that was created for sales order 2, where line 2 has item *A0002*.</span></span>
...
1. <span data-ttu-id="ed5c3-470">Ställ in följande värden för att visa och arbeta med försändelser och behållare som planeras på den specifika förpackningsplatsen:</span><span class="sxs-lookup"><span data-stu-id="ed5c3-470">Set the following values to view and work on shipments and containers that are planned at the specific packing location:</span></span>
    ...
    - <span data-ttu-id="ed5c3-471">**Plats:** *6*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-471">**Site:** *6*</span></span>
...
1. <span data-ttu-id="ed5c3-486">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-486">Select **OK**.</span></span> <span data-ttu-id="ed5c3-487">Behållaren flyttas till platsen *SORTERA* och är klar för sortering.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-487">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="ed5c3-488">Skapa en andra behållare för att lägga till den andra artikeln från LP för försäljningsorder 1 till en ny behållare.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-488">Create a second container to add the second item from the LP for sales order 1 to a new container.</span></span>
1. <span data-ttu-id="ed5c3-489">Klicka på **Ny behållare** i åtgärdsfönstret.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-489">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="ed5c3-490">Godkänn alla standardinställningar och välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-490">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="ed5c3-491">Gör en notering av behållar-ID.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-491">Make a note of the container ID.</span></span>
1. <span data-ttu-id="ed5c3-492">Ange följande värden på snabbfliken **artikelpackning**:</span><span class="sxs-lookup"><span data-stu-id="ed5c3-492">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="ed5c3-493">**Kvantitet:** *1*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-493">**Quantity:** *1*</span></span>
    - <span data-ttu-id="ed5c3-494">**Identifierare:** Artikel *A0001*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-494">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="ed5c3-495">Klicka på **Stäng behållare** i åtgärdsfönstret.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-495">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="ed5c3-496">I dialogrutan **Stäng behållare** välj **Hämta systemvikt** om du vill att systemet ska uppdatera fältet **bruttovikt**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-496">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="ed5c3-497">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-497">Select **OK**.</span></span> <span data-ttu-id="ed5c3-498">Behållaren flyttas till platsen *SORTERA* och är klar för sortering.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-498">The container is moved to the *SORT* location and is ready for sorting.</span></span>

#### <a name="pack-sales-order-2-into-containers"></a><span data-ttu-id="ed5c3-499">Packa försäljningsorder 2 i behållare</span><span class="sxs-lookup"><span data-stu-id="ed5c3-499">Pack sales order 2 into containers</span></span>

1. <span data-ttu-id="ed5c3-500">På sidan **Packa** i fältet **ID-nummer eller leverans** ange mål-LP för rad 1 i försäljningsorder 2.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-500">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for line 1 of sales order 2.</span></span> <span data-ttu-id="ed5c3-501">Markera sedan **tabb** eller **retur** på tangentbordet för att flytta från fältet.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-501">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="ed5c3-502">Klicka på **Ny behållare** i åtgärdsfönstret.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-502">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="ed5c3-503">Godkänn alla standardinställningar och välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-503">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="ed5c3-504">Gör en notering av behållar-ID.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-504">Make a note of the container ID.</span></span>
1. <span data-ttu-id="ed5c3-505">Ange följande värden på snabbfliken **artikelpackning**:</span><span class="sxs-lookup"><span data-stu-id="ed5c3-505">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="ed5c3-506">**Kvantitet:** *1*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-506">**Quantity:** *1*</span></span>
    - <span data-ttu-id="ed5c3-507">**Identifierare:** Artikel *A0001*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-507">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="ed5c3-508">Klicka på **Stäng behållare** i åtgärdsfönstret.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-508">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="ed5c3-509">I dialogrutan **Stäng behållare** välj **Hämta systemvikt** om du vill att systemet ska uppdatera fältet **bruttovikt**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-509">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="ed5c3-510">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-510">Select **OK**.</span></span> <span data-ttu-id="ed5c3-511">Behållaren flyttas till platsen *SORTERA* och är klar för sortering.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-511">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="ed5c3-512">I fältet **ID-nummer eller leverans** ange mål-LP för rad 2 i försäljningsorder 2.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-512">In the **License plate or shipment** field, enter the target LP for line 2 of the sales order 2.</span></span> <span data-ttu-id="ed5c3-513">Markera sedan **tabb** eller **retur** på tangentbordet för att flytta från fältet.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-513">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="ed5c3-514">Klicka på **Ny behållare** i åtgärdsfönstret.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-514">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="ed5c3-515">Godkänn alla standardinställningar och välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-515">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="ed5c3-516">Gör en notering av behållar-ID.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-516">Make a note of the container ID.</span></span>
1. <span data-ttu-id="ed5c3-517">Ange följande värden på snabbfliken **artikelpackning**:</span><span class="sxs-lookup"><span data-stu-id="ed5c3-517">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="ed5c3-518">**Kvantitet:** *1*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-518">**Quantity:** *1*</span></span>
    - <span data-ttu-id="ed5c3-519">**Identifierarfält:** artikel *A0002*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-519">**Identifier field:** Item *A0002*</span></span>

1. <span data-ttu-id="ed5c3-520">Klicka på **Stäng behållare** i åtgärdsfönstret.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-520">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="ed5c3-521">I dialogrutan **Stäng behållare** välj **Hämta systemvikt** om du vill att systemet ska uppdatera fältet **bruttovikt**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-521">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="ed5c3-522">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-522">Select **OK**.</span></span> <span data-ttu-id="ed5c3-523">Behållaren flyttas till platsen *SORTERA* och är klar för sortering.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-523">The container is moved to the *SORT* location and is ready for sorting.</span></span>

<span data-ttu-id="ed5c3-524">Om du vill visa behållardetaljer går du till **Hantering av distributionslager \> Förpackning och skapande av behållare \> behållare** och söker efter de behållar-ID:n som skapades under packningen.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-524">To view the container details, go to **Warehouse management \> Packing and containerization \> Containers**, and search for the container IDs that were created during packing.</span></span>

### <a name="sort-the-containers"></a><span data-ttu-id="ed5c3-525">Sortera behållarna</span><span class="sxs-lookup"><span data-stu-id="ed5c3-525">Sort the containers</span></span>

> [!IMPORTANT]
> <span data-ttu-id="ed5c3-526">När du öppnar menyalternativet **Lastpallsversion** på mobilappen för att utföra utgående sortering visas en knapp har etiketten **Full**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-526">When you access the **Pallet build** menu item on the mobile app to do outbound sorting, you will see a button that is labeled **Full**.</span></span> <span data-ttu-id="ed5c3-527">*Använd inte knappen **Full** för att sortera eller stänga positionen.*</span><span class="sxs-lookup"><span data-stu-id="ed5c3-527">*Don't use the **Full** button to sort or close the position.*</span></span>
>
> <span data-ttu-id="ed5c3-528">Knappen **Full** tillhandahålls som standard och kan inte inaktiveras eller tas bort från sidan.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-528">The **Full** button is provided by default and can't be disabled or removed from the page.</span></span> <span data-ttu-id="ed5c3-529">Den används inte för funktionen *Utgående data*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-529">It isn't used for the *Outbound sorting* feature.</span></span>

#### <a name="sort-the-first-container"></a><span data-ttu-id="ed5c3-530">Sortera den första behållaren</span><span class="sxs-lookup"><span data-stu-id="ed5c3-530">Sort the first container</span></span>

1. <span data-ttu-id="ed5c3-531">Logga in på lager på mobilenheten *62* genom att använda det användar-ID som du skapade för det här scenariot (eller användar-ID för en befintlig demodatanvändare).</span><span class="sxs-lookup"><span data-stu-id="ed5c3-531">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="ed5c3-532">I huvudmenyn, välj **utgående**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-532">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="ed5c3-533">I menyn **utgående** välj **Lastpallsversion**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-533">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="ed5c3-534">I fältet **LP/Con** ange det första behållar-ID som är associerat med försäljningsorder 1.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-534">In the **LP/Con** field, enter the first container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="ed5c3-535">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-535">Select **OK**.</span></span>
1. <span data-ttu-id="ed5c3-536">Eftersom det inte finns några sorteringspositioner för närvarande måste du ange en.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-536">Because no sort positions currently exist, you must specify one.</span></span> <span data-ttu-id="ed5c3-537">I fältet **Sorteringsposition-ID** ange *SP01*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-537">In the **Sort position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="ed5c3-538">Eftersom ingen LP för närvarande är associerad med sorteringspositionen *SP01*, måste du ange ett.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-538">Because no LP is currently associated with sort position *SP01*, you must specify one.</span></span> <span data-ttu-id="ed5c3-539">I fältet **LP** anger du *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-539">In the **LP** field, enter *PLP01*.</span></span>
1. <span data-ttu-id="ed5c3-540">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-540">Select **OK**.</span></span>
1. <span data-ttu-id="ed5c3-541">Eftersom valideringen av sorteringsposition är aktiverad måste du ange sorteringspositionens ID igen.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-541">Because sort position validation is turned on, you must enter the sort position ID again.</span></span> <span data-ttu-id="ed5c3-542">I fältet **Sorteringsposition-ID** ange *SP01*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-542">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="ed5c3-543">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-543">Select **OK**.</span></span>

    <span data-ttu-id="ed5c3-544">Du får ett meddelande arbetet är slutfört.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-544">You receive a "Work completed" message.</span></span>

> [!TIP]
> <span data-ttu-id="ed5c3-545">Om du vill visa sorteringspositionen och LP i den går du till **Lagerhantering \> Förpackning och skapande av behållare \> Positionstilldelningar för utgående sortering**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-545">To view the sort position and the LP in it, go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
>
> <span data-ttu-id="ed5c3-546">På sidan **Positionstilldelningar för utgående sortering** visas alla aktiva sorteringspositioner.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-546">The **Outbound sorting position assignments** page shows all the sort positions that are currently active.</span></span> <span data-ttu-id="ed5c3-547">Fältet **Sortera positionstransaktioner** visar det LP som är kopplat till varje sorteringsposition och de behållare som finns i sorteringspositionen.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-547">The **Sort position transactions** field shows the LP that is associated with each sort position, and the containers that are in the sort position.</span></span> <span data-ttu-id="ed5c3-548">Lägg märke till att en sorteringsposition finns för närvarande och att snabbfliken **Sortera positionskriterier** visar ett villkor för **Leverans – Transportföretag - flyg**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-548">Notice that one sort position currently exists, and that the **Sort position criteria** FastTab shows a criterion of **Shipment – Carrier service - Air**.</span></span>

#### <a name="sort-the-remaining-containers"></a><span data-ttu-id="ed5c3-549">Sortera de kvarvarande behållarna</span><span class="sxs-lookup"><span data-stu-id="ed5c3-549">Sort the remaining containers</span></span>

1. <span data-ttu-id="ed5c3-550">Logga in på lager på mobilenheten *62* genom att använda det användar-ID som du skapade för det här scenariot (eller användar-ID för en befintlig demodatanvändare).</span><span class="sxs-lookup"><span data-stu-id="ed5c3-550">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="ed5c3-551">I huvudmenyn, välj **utgående**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-551">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="ed5c3-552">I menyn **utgående** välj **Lastpallsversion**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-552">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="ed5c3-553">I fältet **LP/Con** ange det andra behållar-ID som är associerat med försäljningsorder 1.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-553">In the **LP/Con** field, enter the second container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="ed5c3-554">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-554">Select **OK**.</span></span> <span data-ttu-id="ed5c3-555">Eftersom sorteringsmallen är inställd på att sortera automatiskt och det redan finns en sorteringsposition som har matchande kriterier, dirigeras du automatiskt till rätt sorteringsposition.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-555">Because the sorting template is set up to sort automatically, and a sort position that has matching criteria already exists, you're automatically directed to the correct sort position.</span></span>
1. <span data-ttu-id="ed5c3-556">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-556">Select **OK**.</span></span>
1. <span data-ttu-id="ed5c3-557">Bekräfta sorteringspositionens ID för att ange att lagret är på rätt plats.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-557">Confirm the sort position ID to indicate that the inventory is in the correct place.</span></span> <span data-ttu-id="ed5c3-558">I fältet **Sorteringsposition-ID** ange *SP01*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-558">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="ed5c3-559">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-559">Select **OK**.</span></span>

    <span data-ttu-id="ed5c3-560">Arbetet har slutförts på den andra behållaren från försäljningsorder 1.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-560">Work is completed on the second container from sales order 1.</span></span> <span data-ttu-id="ed5c3-561">Du kommer nu att sortera resten av behållarna från försäljningsorder 2.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-561">You will now sort the remaining containers from sales order 2.</span></span>

1. <span data-ttu-id="ed5c3-562">I fältet **LP/Con** ange behållar-ID för behållaren från försäljningsorder 2 som innehåller artikel *A0001*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-562">In the **LP/Con** field, enter the container ID of the container from sales order 2 that holds item *A0001*.</span></span> <span data-ttu-id="ed5c3-563">Eftersom transportföretaget skiljer sig åt, uppmanas du att ange en ny sorteringsposition och tilldela en LP till den positionen.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-563">Because the carrier service differs, you're prompted to enter a new sort position and assign an LP to that position.</span></span> <span data-ttu-id="ed5c3-564">Använd sorteringsposition *SP02* och LP *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-564">Use sort position *SP02* and LP *PLP02*.</span></span>
1. <span data-ttu-id="ed5c3-565">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-565">Select **OK**.</span></span>
1. <span data-ttu-id="ed5c3-566">Bekräfta sorteringspositionen genom att ange *SP02* i fältet **sorteringspositions-ID**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-566">Confirm the sort position by entering *SP02* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="ed5c3-567">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-567">Select **OK**.</span></span>

    <span data-ttu-id="ed5c3-568">Arbetet har slutförts på behållaren.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-568">Work is completed on the container.</span></span>

1. <span data-ttu-id="ed5c3-569">I fältet **LP/Con** ange behållar-ID för behållaren från återstående försäljningsorder 2 som innehåller artikel *A0002*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-569">In the **LP/Con** field, enter the container ID for the remaining container from sales order 2 that holds item *A0002*.</span></span> <span data-ttu-id="ed5c3-570">Eftersom transportföretaget är samma som transportföretaget för försäljningsorder 1, visar systemet den befintliga sorteringsposition som har matchande kriterier.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-570">Because the carrier service is the same as the carrier service for sales order 1, the system shows the existing sort position that has matching criteria.</span></span>
1. <span data-ttu-id="ed5c3-571">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-571">Select **OK**.</span></span>
1. <span data-ttu-id="ed5c3-572">Bekräfta sorteringspositionen genom att ange *SP01* i fältet **sorteringspositions-ID**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-572">Confirm the sort position by entering *SP01* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="ed5c3-573">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-573">Select **OK**.</span></span>

    <span data-ttu-id="ed5c3-574">Arbetet har slutförts på behållaren.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-574">Work is completed on the container.</span></span>

### <a name="close-the-outbound-sorting-positions"></a><span data-ttu-id="ed5c3-575">Stäng de utgående sorteringspositionerna</span><span class="sxs-lookup"><span data-stu-id="ed5c3-575">Close the outbound sorting positions</span></span>

<span data-ttu-id="ed5c3-576">När alla lager har sorterats måste positionen stängas innan arbetet kan skapas.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-576">When all inventory has been sorted, the position must be closed before work can be created.</span></span> <span data-ttu-id="ed5c3-577">Sorterat lagerplockningsarbete kommer att skapas för att ta lagret till vikdörren.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-577">Sorted inventory picking work will be created to take the inventory to the bay door.</span></span>

#### <a name="close-a-position-from-the-mobile-device"></a><span data-ttu-id="ed5c3-578">Avsluta en position från den mobila enheten</span><span class="sxs-lookup"><span data-stu-id="ed5c3-578">Close a position from the mobile device</span></span>

1. <span data-ttu-id="ed5c3-579">Logga in på lager på mobilenheten *62* genom att använda det användar-ID som du skapade för det här scenariot (eller användar-ID för en befintlig demodatanvändare).</span><span class="sxs-lookup"><span data-stu-id="ed5c3-579">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="ed5c3-580">I huvudmenyn, välj **utgående**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-580">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="ed5c3-581">I menyn **utgående** välj **Lastpallsversion**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-581">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="ed5c3-582">I fältet **LP/Con** anger du ett behållar-ID som har sorterats för att sortera positionen *SP01*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-582">In the **LP/Con** field, enter a container ID that was sorted to sort position *SP01*.</span></span>
1. <span data-ttu-id="ed5c3-583">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-583">Select **OK**.</span></span>
1. <span data-ttu-id="ed5c3-584">Följande meddelande visas: "behållaren har redan sorterats för att position SP01.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-584">You receive the following message: "The container is already sorted to position SP01.</span></span> <span data-ttu-id="ed5c3-585">Stäng den här positionen?"</span><span class="sxs-lookup"><span data-stu-id="ed5c3-585">Close the position?"</span></span> <span data-ttu-id="ed5c3-586">Välj **Nära**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-586">Select **Close**.</span></span>

    <span data-ttu-id="ed5c3-587">Arbetet har slutförts.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-587">Work is completed.</span></span>

#### <a name="close-a-position-from-outbound-sorting-position-assignments"></a><span data-ttu-id="ed5c3-588">Stäng en position från positionstilldelningar för utgående sortering</span><span class="sxs-lookup"><span data-stu-id="ed5c3-588">Close a position from outbound sorting position assignments</span></span>

1. <span data-ttu-id="ed5c3-589">Gå till **Lagerhantering \> Förpackning och skapande av behållare \> Positionstilldelningar för utgående sortering**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-589">Go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
1. <span data-ttu-id="ed5c3-590">I den vänstra kolumnen, välj **SP02**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-590">In the left column, select **SP02**.</span></span> <span data-ttu-id="ed5c3-591">Den här utgående sorteringspositionsraden är den som du kommer att stänga.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-591">This outbound sorting position row is the one that you will close.</span></span>
1. <span data-ttu-id="ed5c3-592">Klicka på **Stäng position** i åtgärdsfönstret.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-592">On the Action Pane, select **Close position**.</span></span> <span data-ttu-id="ed5c3-593">Den sorteringspositionens post är stängd och visas inte längre.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-593">The sorting position record is closed and is no longer shown.</span></span>

    > [!TIP]
    > <span data-ttu-id="ed5c3-594">Om du vill visa alla poster med stängda positioner markerar du kryssrutan **Visa stängda**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-594">To show all closed position records, select the **Show closed** check box.</span></span>

### <a name="sorted-inventory-picking"></a><span data-ttu-id="ed5c3-595">Plockning i sorterat lager</span><span class="sxs-lookup"><span data-stu-id="ed5c3-595">Sorted inventory picking</span></span>

<span data-ttu-id="ed5c3-596">Du måste slutföra det sorterade lagerplockningsarbetet.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-596">You must complete the sorted inventory picking work.</span></span> <span data-ttu-id="ed5c3-597">När den är avslutad plockas lagret till försäljningsordern.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-597">When it's completed, the inventory will be picked to the sales order.</span></span> <span data-ttu-id="ed5c3-598">Vid den punkten gäller alla andra lagerprocesser.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-598">At that point, all other warehouse processes apply.</span></span>

1. <span data-ttu-id="ed5c3-599">Logga in på lager på mobilenheten *62* genom att använda det användar-ID som du skapade för det här scenariot (eller användar-ID för en befintlig demodatanvändare).</span><span class="sxs-lookup"><span data-stu-id="ed5c3-599">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="ed5c3-600">I huvudmenyn, välj **utgående**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-600">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="ed5c3-601">I menyn **Utgående** välj **Lasta från sortering**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-601">On the **Outbound** menu, select **Load from Sorting**.</span></span>
1. <span data-ttu-id="ed5c3-602">Ange mål-LP-ID från den första sorteringspositionen, *SP01*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-602">Enter the target LP ID from the first sort position, *SP01*.</span></span> <span data-ttu-id="ed5c3-603">Ange fältet **ID** till *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-603">Set the **ID** field to *PLP01*.</span></span>
1. <span data-ttu-id="ed5c3-604">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-604">Select **OK**.</span></span>
1. <span data-ttu-id="ed5c3-605">På sidan **Sorterad lagerplockning: Plocka** visas det plockningsarbete som måste utföras.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-605">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="ed5c3-606">Plocka från platsen *SORTERA* och mål-LP *PLP01*, som har flera artiklar och kvantiteten *3*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-606">Pick from the *SORT* location and target LP *PLP01*, which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="ed5c3-607">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-607">Select **OK**.</span></span>
1. <span data-ttu-id="ed5c3-608">På sidan **Sorterad lagerplockning: Placera** visas det placeringsarbete som måste utföras.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-608">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="ed5c3-609">Placera på platsen *Vikdörr* och mål-LP *PLP01*, som har flera artiklar och kvantiteten *3*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-609">Put to the *Baydoor* location and target LP *PLP01*, which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="ed5c3-610">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-610">Select **OK**.</span></span>

    <span data-ttu-id="ed5c3-611">Arbetet har slutförts.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-611">Work is completed.</span></span>

1. <span data-ttu-id="ed5c3-612">Ange målnummer-ID från den andra sorteringspositionen *SP02*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-612">Enter the target license plate ID from the second sort position, *SP02*.</span></span> <span data-ttu-id="ed5c3-613">Ange fältet **ID** till *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-613">Set the **ID** field to *PLP02*.</span></span>
1. <span data-ttu-id="ed5c3-614">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-614">Select **OK**.</span></span>
1. <span data-ttu-id="ed5c3-615">På sidan **Sorterad lagerplockning: Plocka** visas det plockningsarbete som måste utföras.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-615">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="ed5c3-616">Plocka från platsen *SORTERA* och mål-LP *PLP02*, som har flera artiklar och kvantiteten *1*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-616">Pick from the *SORT* location and target LP *PLP02*, which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="ed5c3-617">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-617">Select **OK**.</span></span>
1. <span data-ttu-id="ed5c3-618">På sidan **Sorterad lagerplockning: Placera** visas det placeringsarbete som måste utföras.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-618">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="ed5c3-619">Placera på platsen *Vikdörr* och mål-LP *PLP02*, som har flera artiklar och kvantiteten *1*.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-619">Put to the *Baydoor* location and target LP *PLP02*, which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="ed5c3-620">Välj **OK**.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-620">Select **OK**.</span></span>

    <span data-ttu-id="ed5c3-621">Arbetet har slutförts.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-621">Work is completed.</span></span>

<span data-ttu-id="ed5c3-622">Från och med denna punkt gäller alla andra lagerprocesser.</span><span class="sxs-lookup"><span data-stu-id="ed5c3-622">From this point forward, all other warehouse processes apply.</span></span>
