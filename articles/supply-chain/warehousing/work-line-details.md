...
description: Denna artikel innehåller information om sidan Arbetsraddetaljer som innehåller en omfattande, sorterbar och filterbar lista över de enskilda arbetsraderna i systemet.
author: Mirzaab
ms.date: 07/01/2020
ms.topic: article
ms.prod: ''
