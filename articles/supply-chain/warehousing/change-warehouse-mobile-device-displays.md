...
ms.locfileid: "859769"
---
# <a name="warehouse-mobile-device-display-settings"></a>Visningsinställningar för mobil enhet på lagerställe

[!include [banner](../includes/banner.md)]

> [!NOTE]
> Den här funktionen har ersatts. Mer information finns i beskrivningen av [borttagna eller gamla funktioner](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
