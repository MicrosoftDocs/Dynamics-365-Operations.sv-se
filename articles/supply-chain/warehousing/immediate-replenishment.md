...
description: Denna artikel beskriver hur du kan använda direkt påfyllnad för att fylla på lagret när ett platsdirektiv inte kan fördela lager.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''
