...
description: Denna artikel ger en översikt över statusfunktionen för lagerställe.
author: Mirzaab
ms.date: 08/09/2022
ms.topic: article
ms.prod: ''
...
## <a name="turn-the-warehouse-location-status-feature-on-or-off"></a>Aktivera eller inaktivera funktionen platsstatus för lagerställe
...
Innan du börjar arbeta i scenariot måste du aktivera exempeldata och konfigurera funktionen enligt beskrivningen i det här avsnittet. För att slutföra exempelscenariot måste du använda antingen mobilappen för distributionslagerhantering eller en webbläsarbaserad emulator. I de steg som beskrivs här används mobilappen för distributionslagerhantering. Stegen för den webbläsarbaserade emulatorn är likartade.
