...
description: I denna artikel beskrivs hur du söker efter och använder de olika typer av förfrågningar som är tillgängliga för modulen Hemtagningskostnad.
author: Weijiesa
ms.date: 02/01/2021
ms.topic: article
ms.prod: ''
