...
description: Denna artikel ger information om leverantörsfakturaenheter, som gör det möjligt att konfigurera kostnadstypkoder för interna eller externt härledda kostnader.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
