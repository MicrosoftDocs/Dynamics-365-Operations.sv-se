---
title: Entiteter som skapas för sjötransport
description: I denna artikel finns information om hur du skapar dataenheter som grupperar de dataenheter som krävs för att skapa en arbetsfärd.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
