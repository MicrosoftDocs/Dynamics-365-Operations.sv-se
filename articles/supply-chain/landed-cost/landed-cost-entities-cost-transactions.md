---
title: Enheter för kostnadstransaktioner
description: Det här ämnet ger information om kostnadstransaktionsenheter, som gör det möjligt att dela upp värdet av en kostnad mellan innehållet i ett kostnadsområde genom att välja en fördelningsmetoden.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
