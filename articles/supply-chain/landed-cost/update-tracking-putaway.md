...
description: I denna artikel beskrivs hur du konfigurerar och kör periodisk uppgift för Uppdateringsspårning vid införsel.
author: Weijiesa
ms.date: 08/02/2021
ms.topic: article
ms.search.form: ''
...
Följ dessa steg för att konfigurera och köra periodisk uppgift för *Uppdateringsspårning vid införsel*:
