...
| Baskalendrar | Kalendrar som använder baskalendern: _\#_ | Denna funktion väntar. För närvarande ignoreras baskalendern när planeringsoptimering aktiveras. Utvärdera om baskalendern behövs för dina affärs processer eller om det är tillräckligt med direkt inställning i kalendrarna. | April-Oktober 2021 | 
...
| Produktion | Strukturlisterader med avrundning eller flera inställningar: _\#_ | Denna funktion väntar. För närvarande ignoreras avrundning och flera inställningar på strukturlisterader när planeringsoptimering är aktiverad, oavsett den här inställningen. | April-Oktober 2021 |
