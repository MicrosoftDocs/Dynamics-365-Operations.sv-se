...
description: Denna artikel innehåller information om hur du visar, hanterar och godkänner planerade order i Planeringsoptimeringen.
author: t-benebo
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8887440"
---
# <a name="view-manage-and-approve-planned-orders"></a>Visa, hantera och godkänna planerade order

[!include [banner](../../includes/banner.md)]

Denna artikel innehåller information om hur du visar, hanterar och godkänner planerade order i Planeringsoptimeringen.
