...
---
# <a name="autofirming-with-planning-optimization"></a>Automatisk bekräftelse med planeringsoptimering
...
> 
> Bekräftade härledda beställningar (inköpsorder i underleverantörer) visar statusen *Undergår granskning* ärende ändras aktiveras.

## <a name="turn-on-autofirming"></a>Aktivera automatisk bekräftelse
...
- Om du vill skriva över den bekräftelse av tidsgräns som har definierats för disponeringsgruppen och artikeldisponering för en viss huvudplan går du till **Huvudplanering** \> **Inställningar** \> **Huvudplaner** och välj en huvudplan. Sedan på snabbfliken **tidsgräns i dagar** ange **Bekräftelse** till **Ja** och ange antalet dagar.
