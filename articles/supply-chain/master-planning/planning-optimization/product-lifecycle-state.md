...
description: I denna artikel beskrivs hur du utesluter produkter baserat på deras livscykeltillstånd när funktionen för Planeringsoptimering används.
author: t-benebo
ms.date: 11/13/2020
ms.topic: article
ms.prod: ''
