...
description: Denna artikel förklarar koncerninterna order och returorder
author: Henrikan
ms.date: 09/01/2021
ms.topic: article
...
ms.locfileid: "8859039"
---
# <a name="intercompany-orders-and-return-orders"></a>Koncerninterna order och returorder

[!include [banner](../../includes/banner.md)]

Denna artikel beskriver hur koncerninterna inköpsorder, försäljningsorder, returorder, inköpsavtal och försäljningsavtal skapas och uppdateras.
