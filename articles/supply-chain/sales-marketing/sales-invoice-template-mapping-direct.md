...
description: I denna artikel diskuteras mallarna och de underliggande uppgifterna som används för att synkronisera sidhuvud och rader för försäljningsfaktura direkt från Dynamics 365 Supply Chain Management till Dynamics 365 Sales.
author: Henrikan
ms.date: 10/26/2017
ms.topic: article
ms.prod: ''
...
I denna artikel diskuteras mallarna och de underliggande uppgifterna som används för att synkronisera sidhuvud och rader för försäljningsfaktura direkt från Dynamics 365 Supply Chain Management till Dynamics 365 Sales.
...
![Mallmappning i Dataintegrering för SalesInvoiceHeader.](./media/sales-invoice-direct-template-mapping-data-integrator-1.png)

### <a name="salesinvoiceline"></a>Rad i försäljningsfaktura

![Mallmappning i Dataintegrering för SalesInvoiceLine.](./media/sales-invoice-direct-template-mapping-data-integrator-2.png)
