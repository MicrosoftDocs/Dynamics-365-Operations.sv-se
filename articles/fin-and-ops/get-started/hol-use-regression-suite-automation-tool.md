...
Den här funktionen kan användas för att validera om en åtgärd utförts. När till exempel en tillverkningsorder skapas, uppskattas och sedan startas, Microsoft Dynamics 365 for Finance and Operations visas meddelandet "produktion – start" för att meddela dig att tillverkningsordern har startats.
...
När testfallet har körts, jämförs meddelandet i Excel-parameterfilen i det meddelande som visas i Finance and Operations. Om meddelandena inte matchar kommer testfallet att misslyckas.
