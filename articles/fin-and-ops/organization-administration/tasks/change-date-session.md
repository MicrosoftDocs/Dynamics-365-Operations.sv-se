...
1. <span data-ttu-id="c4b67-107">Gå till Allmänt > Allmänt > Sessionsdatum och -tid.</span><span class="sxs-lookup"><span data-stu-id="c4b67-107">Go to Common > Common > Session date and time.</span></span>
2. <span data-ttu-id="c4b67-108">Ange ett datum i fältet Datum.</span><span class="sxs-lookup"><span data-stu-id="c4b67-108">In the Date field, enter a date.</span></span>
3. <span data-ttu-id="c4b67-109">Klicka på OK.</span><span class="sxs-lookup"><span data-stu-id="c4b67-109">Click OK.</span></span>
