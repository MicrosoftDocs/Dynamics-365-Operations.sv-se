...
5. Hitta och markera önskad post i listan.
    * Välj ett syfte att tilldela till din organisationshierarki.  
6. Klicka på Lägg till.
7. Markera vald rad i listan.
    * Hitta hierarki som du just skapat.  
8. Klicka på OK.

## <a name="add-organizations-to-the-hierarchy"></a>Lägg till organisationer i hierarkin
1. Hitta och markera önskad post i listan.
    * Välj hierarki.  
2. Klicka p Visa hierarki
    * Lägg till fler organisationer efter behov.  
    * Klicka på Redigera och sedan Sätt in om du vill lägga till en organisation.     När du är klar med ändringar, kan du spara ett utkast och/eller publicera ändringarna.  
