...
[!include[task guide banner](../../includes/task-guide-banner.md)] När du har angett en projektbudget eller ändring av projektbudget, och innan du skickar den för godkännande, kan du allokera beloppen i perioder. Om budgetvärden eller budgetändringen avvisas, kan du också tilldela belopp om du skickar det på nytt. 
