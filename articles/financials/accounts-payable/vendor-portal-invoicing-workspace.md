...
Mer information finns i [samarbeta med leverantörer genom att använda leverantörsportalen](../../supply-chain/procurement/collaborate-vendors-vendor-portal.md)
