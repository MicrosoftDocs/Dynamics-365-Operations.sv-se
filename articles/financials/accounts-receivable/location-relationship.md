...
# <a name="add-new-location-roles-and-party-relationship-types"></a>Lägg till nya platsroller och partrelationstyper 

## <a name="add-new-location-roles"></a>Lägg till nya platsroller
...
## <a name="add-new-party-relationship-types"></a>Lägg till nya partrelationstyper 
