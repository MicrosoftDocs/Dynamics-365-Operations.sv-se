...
-  Dynamics 365 for Finance and Operations (förkonfigurerad)
...
|  **Datakällor** |  **Dataanslutning för importerade transaktioner** | **Dynamics 365 for Finance and Operations datakoppling**  | **Datakoppling för Dynamics AX**  |
|---|---|---|---|
