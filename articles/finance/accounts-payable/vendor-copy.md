...
description: Den här artikeln beskriver hur du använder delade nummerserier för att kopiera en leverantör till en annan juridisk person men behålla samma leverantörs-ID.
author: sunfzam
ms.date: 08/24/2018
ms.topic: index-page
ms.prod: ''
