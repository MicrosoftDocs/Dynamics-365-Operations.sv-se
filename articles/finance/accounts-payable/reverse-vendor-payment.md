...
description: Det här avsnittet beskriver skillnaderna mellan att återföra, ta bort, annullera och avvisa en betalning. Den beskriver dessutom de två metoderna för att återföra en leverantörscheck.
author: abruer
ms.date: 08/22/2017
ms.topic: article
ms.prod: ''
