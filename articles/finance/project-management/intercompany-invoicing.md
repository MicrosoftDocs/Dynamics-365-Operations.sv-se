...
description: Den här artikeln innehåller information om och exempel på koncernintern fakturering för projekt.
author: KimANelson
manager: AnnBe
ms.date: 09/14/2017
ms.topic: article
...
ms.locfileid: "2175036"
---
# <a name="intercompany-invoicing"></a>Koncernintern fakturering

[!include [banner](../includes/banner.md)]

Den här artikeln innehåller information om och exempel på koncernintern fakturering för projekt.
