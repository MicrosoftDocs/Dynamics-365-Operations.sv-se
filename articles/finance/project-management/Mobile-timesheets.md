...
Den här mobilappen är kompatibel med iPhone med plattformsuppdatering 15.
...
2.  På din mobila enhet, kom åt webbadressen som noterades i föregående steg.
 
3.  Välj **Projekthantering och redovisning**\>**Tidrapporter**\>**Mina tidrapporter (optimerad för mobil)**.

4.  Markera **Nytt**.

5.  Välj en resurs.

6.  Du kan se kalenderdatum för den aktuella veckan.

7.  Klicka på **OK**.

8.  Klicka på **+** om du vill lägga till en ny rad.

9.  Välj kund- och projektinformation för tidrapportraden.

10. Ange hur många timmar du arbetade för den valda projektraden.

11. Tillval: Ange eventuella interna och externa kommentarer för timmarna.

12. Välj bakåtåtgärden för att spara timinformationen och återgå till visning av tidrapportdetaljer.
