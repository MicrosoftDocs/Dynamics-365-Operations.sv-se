...
description: Denna artikel innehåller felsökningsinformation som kan vara till hjälp när momsbeloppet är 0 (noll) eller när moms inte beräknas.
author: shtao
ms.date: 04/01/2021
ms.topic: article
ms.prod: ''
