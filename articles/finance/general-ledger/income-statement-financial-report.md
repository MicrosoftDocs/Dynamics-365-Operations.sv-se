...
description: Det här avsnittet beskriver standardrapporten för inkomstredovisning. Här beskrivs också de byggstenar som associeras med den här rapporten.
author: jcart1106
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8734759"
---
# <a name="income-statement-financial-report"></a>Resultaträkning

[!include [banner](../includes/banner.md)]

Det här avsnittet beskriver standardrapporten för inkomstredovisning. Här beskrivs också de byggstenar som associeras med den här rapporten. 
