...
description: I den här artikeln beskrivs rekommenderade metoder för att konfigurera bokföringsprofiler.
...
ms.locfileid: "8849914"
---
# <a name="recommended-practices-for-posting-profiles"></a>Rekommenderade metoder för bokföringsprofiler

Det finns flera rekommenderade metoder som du bör följa när du konfigurerar bokföringsprofiler i hela systemet. I den här artikeln beskrivs olika scenarier och motsvarande rekommenderade metoder.
