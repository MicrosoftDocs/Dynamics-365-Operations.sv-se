...
|---------------------------------------|-------------------------------------------------------------------------|----------------------------------|
| Underhåll säkerhet för ekonomiska rapporter | Underhåll säkerhet och utför administrativa uppgifter för ekonomiska rapporter. | FinancialReportsSecurityMaintain |
...
|---------------------------------------|-------------------------------------------------------------------------|----------------------------------|
| Underhåll säkerhet för ekonomiska rapporter | Underhåll säkerhet och utför administrativa uppgifter för ekonomiska rapporter. | FinancialReportsSecuritySystemMaintain |
...
| Privilegieetikett                       | Uppdrag                                  | Roller                                                                           |
|---------------------------------------|---------------------------------------|---------------------------------------------------------------------------------|
...
Slipstream-processen är helt automatiserad och kräver inga kundåtgärder. Tre topologier förbrukar slipstream, var och en på något olika sätt:

- **Lokal** – Lokala distributioner har inte stöd för slipstream och sammanslagning.
- **Infrastruktur som en tjänst (IaaS)** – Slipstream-logiken används vid alla försök att uppdatera ekonomisk rapportering. Den innehåller binära uppdateringar eller utsändningar som innehåller binära uppdateringar.
- **Självbetjäning** – Alla transaktioner som kräver ekonomisk rapporteringsupptid tillämpar slipstream-logiken:

    - Binära uppdateringar eller utsändningar som innehåller binära uppdateringar
    - Utskick av annan infrastrukturtid
    - Paketdistributioner av AOT
...
4. Kör följande kommando: .\RegisterETW.ps1
    ...
    Öppna Loggboken igen så visas nu dessa loggar under **Microsoft > Dynamics**:
