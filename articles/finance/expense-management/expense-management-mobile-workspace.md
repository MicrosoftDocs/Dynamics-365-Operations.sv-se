...
Denna mobila arbetsyta är avsedd att användas med mobilappen Dynamics 365 Unified Operations.
...
- Ta en bild av ett kvitto och skicka det till Dynamics 365 Finance. En användare kan sedan bifoga den bilden i en utgiftsrapport senare.
...
Du kan även använda dessa funktioner:
...
Kraven varierar baserat på versionen som har distribuerats i organisationen.

### <a name="prerequisites-if-you-use-dynamics-365-finance"></a>Förutsättningar om du använder Dynamics 365 Finance 
Om Finance används inom din organisation måste systemadministratören publicera den mobila arbetsytan **Utläggshantering**. Instruktioner finns i [Publicera en mobil arbetsyta](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
...
Hämta och installera mobilappen Dynamics 365 Unified Operations:
