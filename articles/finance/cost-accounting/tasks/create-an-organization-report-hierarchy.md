...
4. Klicka på **Skapa**.
5. Skriv Organization USP2 i fältet **Dimensionshierarkins namn**.
6. Ange eller välj ett värde i fältet **Dimension**.
    * Välj Kostnadsställen.  
7. Klicka på **Spara**.
8. Klicka på **Visa hierarki**.
9. Klicka på **Ny**.
10. Skriv CEO i fältet **Nodnamn**.
11. Klicka på **Spara**.
12. Klicka på **Ny**.
13. Skriv "CEO cost centers" i fältet **Nodnamn**.
14. Klicka på **Spara**.
15. Klicka på **Ny**.
16. Skriv "Region East" i fältet **Nodnamn**.
17. Klicka på **Spara**.
18. Klicka på **Ny**.
...
23. Klicka på **Ny**.
24. Skriv "Region West" i fältet **Nodnamn**.
25. Klicka på **Spara**.
26. Klicka på **Ny**.
...
31. Klicka på **Ny**.
32. Skriv "CFO cost centers" i fältet **Nodnamn**.
33. Klicka på **Spara**.
34. Klicka på **Ny**.
35. Skriv "Marketing campa" i fältet **Nodnamn**.
36. Skriv "Marketing campaign" i fältet **Nodnamn** .
37. Klicka på **Spara**.
38. Klicka på **Ny**.
...
43. Klicka på **Ny**.
44. Skriv "Trade shows" i fältet **Nodnamn**.
45. Klicka på **Spara**.
46. Klicka på **Ny**.
...
51. Skriv "CIO cost centers" i fältet **Nodnamn**.
52. Klicka på **Spara**.
53. Klicka på **Ny**.
54. Skriv "Call centers" i fältet **Nodnamn**.
55. Klicka på **Spara**.
56. Klicka på **Ny**.
