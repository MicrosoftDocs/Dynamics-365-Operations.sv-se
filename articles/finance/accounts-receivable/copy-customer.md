...
description: Den här artikeln beskriver hur du använder delade nummerserier för att kopiera en kund till en annan juridisk person men behålla samma kund-ID.
author: abruer
ms.date: 08/31/2018
ms.topic: index-page
ms.prod: ''
