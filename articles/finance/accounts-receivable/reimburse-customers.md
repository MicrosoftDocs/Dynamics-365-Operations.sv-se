...
description: Det här avsnittet förklarar hur du skapar återbetalningstransaktioner för en grupp med kunder.
...
ms.locfileid: "8735651"
---
# <a name="reimburse-customers"></a>Återbetala kunder

[!include [banner](../includes/banner.md)]

Det här avsnittet förklarar hur du skapar återbetalningstransaktioner för en grupp med kunder. Om en kund har ett kreditsaldo, kan du återbetala kunden för beloppet för saldot. 
