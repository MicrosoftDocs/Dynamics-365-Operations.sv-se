...
ms.locfileid: "5224799"
---
# <a name="collections-in-accounts-receivable"></a>Samlingar i kundreskontra

[!include [banner](../includes/banner.md)]

Inkassoinformation för kundreskontra hanteras i en central vy med sidan Microsoft Dynamics 365 Finance Inkasso. Kredit- och inkassoansvariga kan använda denna centrala vy för att hantera inkasseringar. Inkassohandläggare kan börja inkassoprocessen från kundlistor som genereras med hjälp av fördefinierade inkassokriterier eller från sidan Kunder.
