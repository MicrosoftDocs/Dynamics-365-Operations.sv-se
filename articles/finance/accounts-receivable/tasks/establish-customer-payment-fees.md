...
8. Klicka på **Spara**.
9. Klicka på **Betalningsavgiftsinställning**. Betalningsavgiftinställningar används för att definiera villkoren för betalningsavgiften, när ska bedömas.  Du kan till exempel definiera som avgiften beräknas, om företaget är USMF OPER, och betalningsmetoden är check.  
...
13. I fältet **Betalningsmetod**, välj den betalningsmetod som avgiften ska bedömas för. Du kan till exempel ålägga en avgift till kunden om de skickar betalningar som en check, snarare än som en elektronisk betalning.  
