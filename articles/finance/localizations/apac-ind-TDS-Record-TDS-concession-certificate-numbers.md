...
description: I den här artikeln beskrivs hur du registrerar koncessionscertifikatnumren för skatteavdrag vid källan (TDS) som har utfärdats till leverantörer.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8846625"
---
# <a name="record-tds-concession-certificate-numbers"></a>Registrera koncessionscertifikatnummer för TDS

[!include [banner](../includes/banner.md)]

I den här artikeln beskrivs hur du registrerar koncessionscertifikatnumren för skatteavdrag vid källan (TDS) som har utfärdats till leverantörer.
