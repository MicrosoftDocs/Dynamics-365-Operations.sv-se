...
description: I det här avsnittet förklaras hur du flyttar NF-e XML-filer från din Microsoft Dynamics 365 Finance- eller Dynamics 365 Supply Chain Management-databas och gör dem tillgängliga som bilagor istället.
author: gionoder
ms.date: 11/11/2021
ms.topic: article
ms.prod: ''
