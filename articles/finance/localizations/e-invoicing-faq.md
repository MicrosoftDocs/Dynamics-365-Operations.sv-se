...
---
# <a name="electronic-invoicing-faq"></a>Vanliga frågeställningar om E-fakturering

[!include [banner](../includes/banner.md)]

I det här avsnittet finns svar på vanliga frågeställningar om e-fakturering. E-fakturering utökar den elektroniska fakturerings kapaciteten som finns i Dynamics 365 Finance, Dynamics 365 Supply Chain Management och Dynamics 365 Project Operations. 
...
## <a name="does-electronic-invoicing-support-the-on-premises-installations-of-finance-supply-chain-management-and-project-operations"></a>Har e-fakturering stöd för installationer av Finance, Supply Chain Management och Project Operations? 
...
## <a name="how-does-electronic-invoicing-handle-file-attachments-into-the-electronic-invoice-is-a-sharepoint-server-needed-when-embedding-pdf-files-into-the-xml-file"></a>Hur hanterar e-fakturering filbilagor i den elektroniska fakturan? Behövs en SharePoint-server när PDF-filer lagras i XML-filen?
...
## <a name="is-electronic-invoicing-available-according-to-the-regulations-of-my-countryregion"></a>Är e-fakturering tillgänglig enligt reglerna för mitt land/min region?

E-fakturering är en mikrotjänstplattform som är global tillgänglig.
...
## <a name="do-i-need-to-sign-up-to-get-electronic-invoicing--or-just-turn-it-on-in-feature-management"></a>Behöver jag registrera mig för att få e-fakturering eller bara aktivera den i funktionshantering?
...
## <a name="does-electronic-invoicing-work-with-tier-1-virtual-machines-what-is-the-minimal-required-environment"></a>Fungerar e-fakturering med virtuella nivå 1-maskiner? Vilken miljö krävs minimal?

Integrationen i e-fakturering kräver minst en virtuell nivå 2-maskin som är värd för Finance och Supply Chain Management. Mer information om miljöplanering finns i [miljöplanering](../../fin-ops-core/fin-ops/imp-lifecycle/environment-planning.md).

## <a name="does-electronic-invoicing-have-a-test-mode-for-testing-invoice-submission"></a>Har e-fakturering ett testläge för att testa sändning av fakturor?
...
Ja. Information om tillgängligheten på funktioner för e-fakturering och de format de stöder finns i [Tillgänglighet för elektroniska faktureringsfunktioner](e-invoicing-configuration-rcs.md#availability-of-electronic-invoicing-features).
