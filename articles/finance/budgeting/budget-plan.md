...
description: Målet med den här övningen är att ge en guidad visning av Microsoft Dynamics 365 Finance-funktionsuppdateringar inom området Budgetplanering. Syftet med övningen är att illustrera ett kort konfigureringsexempel av budgetplaneringsmodulen och visa hur budgetplaneringen kan utföras med hjälp av den här konfigurationen.
author: panolte
ms.date: 06/25/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8712016"
---
# <a name="budget-planning"></a>Budgetplanering

[!include [banner](../includes/banner.md)]

Målet med den här övningen är att ge en guidad visning av Microsoft Dynamics 365 Finance-funktionsuppdateringar inom området Budgetplanering. Syftet med övningen är att illustrera ett kort konfigureringsexempel av budgetplaneringsmodulen och visa hur budgetplaneringen kan utföras med hjälp av den här konfigurationen.  I det här övningen fokuseras på följande processer och uppgifter:
...
[![Ange.](./media/screenshot7.png)](./media/screenshot7.png) 

1.6. Välj finansavdelningen för budgethierarkin. 

[![Ekonomi.](./media/screenshot8.png)](./media/screenshot8.png)
...
***Viktigt!** _ _Se till att du befinner dig i DEMF-juridisk enhet när du utför den här uppgiften, eftersom organisationssäkerhet tillämpas per juridisk enhet* 
...
[![Designa.](./media/screenshot19.png)](./media/screenshot19.png) 
...
[![Uppdatera.](./media/screenshot23.png)](./media/screenshot23.png)
...
*Obs: Se till att välja "Spara som" och välja den plats där mallen ska sparas, om du vill redigera. Om användaren väljer "Öppna" i dialogrutan utan att spara, bibehålls inte ändringar som gjorts i filen när filen stängs.* 
...
[![Budgetplanvisning.](./media/screenshot31.png)](./media/screenshot31.png)
...
[![Godkänn automatiskt.](./media/screenshot37.png)](./media/screenshot37.png) 
...
[![Budgetplan för fasövergång.](./media/screenshot40.png)](./media/screenshot40.png) 
...
[![Ursprunglig(a) och överförd(a).](./media/screenshot41.png)](./media/screenshot41.png)
