...
[![Allokeringsmetoden Allokera över flera perioder.](./media/allocateacrossperiods-300x259.png)](./media/allocateacrossperiods.png)
...
**Allokera till dimensioner** – budgetplanraderna allokeras från källbudgetplaneringsscenariot till en eller flera rader i målscenariot baserat på de procentsatser och ekonomiska dimensioner som har definierats i ett valt budgetallokeringsvillkor.           
