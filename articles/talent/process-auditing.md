...
Du kan visa spårade data i Power BI genom att använda OData-kopplingen. Mer information finns i [ansluta till OData-feeder i Power BI Desktop](https://docs.microsoft.com/en-us/power-bi/desktop-connect-odata).
