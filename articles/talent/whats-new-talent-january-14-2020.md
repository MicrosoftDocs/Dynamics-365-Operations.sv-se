...
ms.locfileid: "4529124"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-january-14-2020"></a>Nyheter och ändringar i Dynamics 365 Talent (14 januari 2020)
...
Ändringar som beskrivs i detta avsnitt gäller versionsnummer 8.1.2709. Siffror inom parenteser i vissa rubriker refererar till supportnummer i Microsoft Dynamics Lifecycle Services (LCS).

### <a name="system-unable-to-generate-calendar-days-when-importing-through-data-management-framework-381195"></a>Det gick inte att generera kalender dagar vid import från Data Management Framework (381195)

Denna ändring korrigerar ett problem där importen av kalenderdagar genererar felet **Ogiltig datumformat**. Det här felet förhindrar att arbetskalenderns datumrader skapas.
