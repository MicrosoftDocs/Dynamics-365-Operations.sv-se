...
ms.locfileid: "4462626"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Nyheter och ändringar i Dynamics 365 Talent (12 november 2019)
...
Ändringar som beskrivs i detta avsnitt gäller versionsnummer 8.1.2604. Siffror inom parenteser i vissa rubriker refererar till supportnummer i Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Arbetsplatsen uppdateras inte via Excel-arbetsboken (369727)

Med den här ändringen kan du nu uppdatera arbetsplatsen med hjälp av Office-arbetsboken.
