...
En ändring har gjorts för att uppdatera integrationen mellan Core HR och Attract som är relaterad till kandidater att anställa. För att kandidater att anställa ska visas i arbetsytan **personalhantering** kommer följande Common Data Service-enheter användas:
...
| Common Data Service värde                   | Finance and Operations-värde                     |
| ----------------------------|--------------------------------------------------|
| 75440000                    | Man                                             |
| 75440001                    | Kvinna                                           |
| 75440002                    | Ingen                                             | 
