---
title: Visa status för integration av medarbetare och dina uppgifter
description: I det här avsnittet beskrivs hur du använder Microsoft Dynamics 365 for Talent - Onboard-appen för att spåra var nyanställda befinner sig i sin integreringsprocess.
...
Microsoft Dynamics 365 for Talent: Onboard låter dig visa de framsteg som dina nyanställda gör i sina integreringsaktiviteter. Du kan också visa alla aktiviteter som har tilldelats dig från integreringsguider.

## <a name="view-the-status-of-onboarding-employees"></a>Visa status för integration av medarbetare
...
1. Välj **uppgifter** i menyn till vänster. Du ser en översikt över alla integreringsuppgifter som har tilldelats dig från de integreringsguider som skickades till medarbetarna.
2. Om du vill öka detaljnivån väljer du önskad uppgift.
3. Följ upp med den nyanställde enligt behov.
4. När du har slutfört uppgiften markerar du den som slutförd genom att lägga till en bockmarkering i cirkeln.
