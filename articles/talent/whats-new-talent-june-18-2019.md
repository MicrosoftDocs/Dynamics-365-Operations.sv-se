...
Ändringar som beskrivs i detta avsnitt gäller versionsnummer 8.1.2347.

### <a name="confirmation-of-course-participants-causes-an-error"></a>Bekräftelse av kursdeltagare orsakar fel

Dialogrutan för utskrift av rapporten om kursdeltagare har tagits bort. Den här rapporten stöds inte i Talent.

### <a name="the-compensation-section-of-the-transfer-worker-page-isnt-available-in-some-scenarios"></a>Sektionen Kompensation på sidan Överför arbetare är inte tillgänglig i vissa fall

Den här ändringen låter användarna ange kompensationsinformation när de fyller i sidan **Överför arbetare**.
...
Följande entiteter stöder anpassade fält: inkomstkod och kompensationsreferenspunkter. 
