...
# Lagerpåfyllnad med uttags-kanbans
...
## Arbetsflöde för materialpåfyllnad som använder uttags-kanban
...
## Konfigurera lagerställesarbete för kanbanplockning för uttags-kanban
...
## Scenario 1: Fyll på en plats för produktionsinleverans genom att använda en fast uttags-kanban
...
## Scenario 2: Komplettera automatiskt överföringsaktiviteten när kanban-plockningsarbete bearbetas
