...
<td>Markera det här alternativet om du vill visa status för artiklar i lager. Mer information finns i <a href="/inventory/inventory-statuses.md">Fördelar med att använda lagerstatus</a>. Det här alternativet är tillgängligt för alla menyalternativ som använder befintligt arbete, förutom rullande inventering.</td>
</tr>
<tr class="odd">
