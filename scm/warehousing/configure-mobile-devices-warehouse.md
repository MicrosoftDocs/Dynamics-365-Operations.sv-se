...
<ul>
<li>Om du får ett nytt batchnummer, används standardinställningsbatchdispositionskoden som anges på artikelmodellgruppen.</li>
...
[Ställ in ett menyalternativ för mobila enheter för att utföra arbete av typen Inköpsorder (uppgiftsguide)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu)

[Ställ in ett menyalternativ för mobila enheter för att registrera mottagna artiklar (uppgiftsguide)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu-item-register-received-items)
