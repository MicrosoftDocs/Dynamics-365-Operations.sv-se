...
# <a name="migrate-from-ax-2012-to-finance-and-operations"></a>Migrera från AX 2012 till Finance and Operations
...
4.  Tilldela en platsprofil till alla platser. Du kan enkelt slutföra det här steget genom att använda Microsoft Office-integreringen direkt från sidan. Du kan antingen exportera och importera data, eller använda dataenheten i [Datahantering](/dynamics365/unified-operations/dev-itpro/data-entities/data-entities).
