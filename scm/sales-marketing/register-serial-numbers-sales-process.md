...
# Registrera serienummer i en försäljningsprocess
...
## När registrerar jag serienummer under en försäljningsprocess?
...
## Kan jag ange serienummer genom att skanna dem, eller måste jag skriva in dem?
...
## Om jag aktiverar serienummer för försäljningsprocessen, behöver jag registrera alla serienummer för alla artiklar?
...
## Kan jag registrera serienummer för delfakturor och delleveranser?
...
## Vad gör jag när ett serienummer inte är läsligt?
...
## Kan jag korrigera eller ändra serienummer som jag har registrerat för en försäljningsorder?
...
## Kan där jag visa serienumren som har skickats med en viss följesedel, eller som har inkluderats i en faktura?
...
## Kan jag visa de seriekopplade artiklar som jag har i lager?
...
## Kan jag registrera serienummer för fångstviktartiklar?
...
## Vilka säkerhetsroller krävs för att registrera serienummer under försäljningsprocessen?
