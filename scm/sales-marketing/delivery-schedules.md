...
Använd en leveransplan när det totala antalet på en order- eller offertraden måste levereras i flera leveranser. Enskilda försändelserna representeras av leveransrader. Två eller fler leveransrader utgör en leveransplan. Leveransraderna kan ha andra leveransdatum, kvantiteter, leveranssätt och lagringsdimensioner, till exempel plats och lagerställe.  
...
När du skapar en leveransplan, ändras typen för den ursprungliga orderraden automatiskt till **Orderrad med flera leveranser**. En rad med den här typen kallas för en kommersiella rad och är markerade med en ikon. Leveransraden är markerad med en annan ikon. Om du ändrar kvantiteten på en leveransrad uppdateras kommersiellt raden på den totala kvantiteten i leveransplanen. Handelsavtalet har definierats i en total rabatt för ordern, garanterar leveransplanen att din beställning berättigade slutrabatt, även om ordern är uppdelad i separata leveranser.  
