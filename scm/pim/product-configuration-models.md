...
Du kan även ange ett villkor för attribut. Om villkoret uppfylls, måste ett värde angetts för obligatoriska attribut. Villkor är uttryck som måste uppfyllas för att attribut, strukturlisterader och flödesoperationer ska inkluderas i en modell för produktkonfiguration. Alla attribut som refereras i ett villkor, blir obligatorisk. Vi rekommenderar att du väljer attribut som obligatoriska på fliken <strong>Attribut</strong>. Detta kan göra det enklare att identifiera obligatoriska attribut. Attributvärden är en viktig del av du vill återanvända konfigurationer. Attributvärden används för att fastställer om en konfiguration finns, som matchar val som en användare har gjort under en konfigurationssession.</td>
</tr>
<tr class="odd">
<td>Attributtyper</td>
