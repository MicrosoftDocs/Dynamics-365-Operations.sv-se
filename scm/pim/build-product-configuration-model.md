...
En systemdefinierad tabellbegränsning definieras genom att välja den Microsoft Dynamics 365 for Operations-tabell som ska användas som referens, och sedan välja fält från denna tabellen för att bilda kolumnerna i begränsningen. Raderna i tabellbegränsningen är rader i Dynamics 365 for Operations-tabellen som finns vid tidpunkten för konfigurering.  
