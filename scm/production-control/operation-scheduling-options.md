...
Flera inställningar anger hur produktionens tidsplaner beräknas. Du definierar dessa inställningar på sidan **Operations scheduling**. Nedan följer information som beskriver planeringsalternativen.
...
-   **Framåt från tidsplaneringsdatum** – Tidsplanering framåt från det datum som anges i fältet **Scheduling date**. Om du inte anger något tidsplaneringsdatum, kommer tidsplaneringsriktningen att vara framåt från aktuellt datum.
