...
-   Tolerans-åtgärder för ett attribut i den **heltal** eller **del** typ. Om värdet för attributet ligger utanför intervallet för minsta och största används kan åtgärden vara antingen en varning eller ett felmeddelande.
