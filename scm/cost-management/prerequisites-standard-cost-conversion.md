...
4.  Tilldela **redovisningskonton** som är relaterade till standardkostnader, särskilt omvärderingsavvikelsen. Använd den **bokföring** sida (**lagerhantering**&gt;**inställningar**) för att tilldela redovisningskonton som är relaterade till standardkostnader. För en process för standardkostnadskonvertering måste du (som ett minimikrav) tilldela kontot för omvärderingsavvikelsen för alla artiklar och alla kostnadsgrupper. Använd sidan **Kontoplan** för att definiera de redovisningskonton som kommer att behövas för standardkostnader. Använd sidan **Transaktionskombinationer** om vill du göra det möjligt att använda kostnadsrelationer (för tabeller, grupper och alla) innan du definierar artikelbokföringsregler.
