...
-   När du väljer avgränsare för kontoplaner, kan du välja något av alternativen dubbel avgränsare: dubbla bindestreck (-) dubbelstreck (|) eller dubbla punkt (.) eller dubbel understrykning (\_\_).
