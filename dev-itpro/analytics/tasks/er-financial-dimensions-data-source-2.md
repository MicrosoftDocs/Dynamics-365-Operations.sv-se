...
---
# <a name="map-models--to-use-financial-dimensions-as-a-data-source-for-electronic-reporting-er"></a>Mappa modeller som använder ekonomiska dimensioner som datakälla för elektronisk rapportering (ER)
