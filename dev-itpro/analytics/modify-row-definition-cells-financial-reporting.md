...
# Ange en radkod i en raddefinition
...
### Ändra en radkod i en raddefinition
...
### Lägg till beskrivningen för en rad i en rapport
...
### Lägga till ytterligare text från ett rapporteringsträd i beskrivningen
...
### Begränsa den ytterligare texten till en viss rapporteringsenhet.
...
### Lägg till en formatkod till en rapportrad
...
## Ange relaterade formler/rader/enheter
...
### Använd enradsumma i en raddefinition
...
### Komponenter för en radsummaformel
...
### Relatera en formatrad till en beloppsrad
...
### Exempel på att förhindra utskrift av rader
...
## Välj basraden för en kolumnberäkning
...
### Välj basraden i raddefinitionen för en kolumnberäkning
...
## Välj en sorteringskod för en raddefinition
...
### Exempel på stigande och fallande kolumnvärden
...
## Ange en cell för Formatåsidosätt
...
## Ange en cell för normalt saldo
...
## Ange en länk till den ekonomiska dimensioncellen
...
### Ange en dimension eller intervall
...
## Visa nollsaldokonton i en raddefinition
...
## Använd jokertecken och intervall i en raddefinition
...
### Intervall för enkelt segment eller enkel dimension
...
### Intervaller med flera segment eller flera dimensioner
...
## Lägga till eller dra ifrån från andra konton i en raddefinition
...
### Addera eller subtrahera konton från andra konton
...
## Beskrivning av dialogrutan Dimensioner.
...
## Lägg till definitionvärdeuppsättningar i en raddimension
...
### Skapa en dimensionsvärdeuppsättning.
...
### Uppdatera en dimensionsvärdeuppsättning.
...
### Kopiera en dimensionsuppsättning
...
### Radera en dimensionsuppsättning
