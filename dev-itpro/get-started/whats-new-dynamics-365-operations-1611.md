...
| Få mer information om försändelsesupport i Dynamics 365 for Operations                                                                                                         | För mer information om support för försändelseprocesses, se [Försändelse](/dynamics365/operations/scm/inventory/consignment), [Ställa in försändelse](/dynamics365/operations/scm/inventory/set-up-consignment), [Skapa en order för försändelseåteranskaffning (uppgiftsgudie)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) och [Ändra ägarskapet för försändelselagret baserat på produktionsbegäran (uppgiftsgudie)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
