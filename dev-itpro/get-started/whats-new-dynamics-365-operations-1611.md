...
| Öppna fem nya Power BI innehåll Pack för personal                                     | Aktivera nya innehåll Pack organisationer och personal personalchefer motsvarar följande: personalen mått • demografisk uppdelning av ålder, kön och civilstånd • jämför partikelhållfasthet skattesatser på årsbasis och visa motiveringen som medarbetare har lämnar organisationen • visa en lista över lediga befattningar som en jämförelse av öppet för stängda befattningar kompensation och förmåner • jämför per timme och anställda • visa antalet medarbetare som har anmälts i tillgängliga förmåner • Visa medarbetare efter anställningstyp rekrytering • analysera hos sökande baserat på antalet sökande, var de kommer från, och befattningar som de tillämpar för organisationens utbildning • kursregistrering efter plats • Couse närvaro av status • lista över medarbetare registreras för kurser medarbetarens kompetenser och utveckling • lista över kompetenser medarbetare • uppdelning av färdighetstyper som medlem i gruppen |
...
<td>Bank LC diverse Tillägget allokeringen format för Saudiarabien</td>
</tr>
<tr class="odd">
...
| Vad du kan göra                                                                                                                                                                                                      | Varför detta är viktigt                                                                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Ställa in standardorderinställningar för försäljning och inköp baserat på aktiva produktdimensioner på produktmallen. Därför kan du definiera standardorderinställningar för lagerhållningsenhet (SKU) eller en delvis lagerhållningsenhet. | Du kan ange standardorderinställningar som gäller för alla produktdimensioner eller en kombination av produktdimensioner. **Till exempel** du sälja en produkt som heter Polo T-shirt. Denna produkt är tillgängliga i två färger: grönt och blått. Den är också tillgänglig i två storlekar: small och medium. Färg och storlek är aktiva produktdimensioner för Polo T-shirt. Du kan spärra inköp av alla gröna Polo T-shirt oavsett deras storlek. |
...
| Vad du kan göra                                                                                                                                                                                                                                                                        | Varför detta är viktigt                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Visa anpassade produktrekommendationer vid flera touchpoints i kassan (PO) för att avgöra vilken kund är intresserad utifrån deras tidigare inköp, artiklar i deras önskelista och artiklar som andra kunder köpt online och bankkontor och andra butiker | Personliga rekommendationer hjälpa kunden med upptäckt produkt för återförsäljare med stora kataloger och stärker butiken associerad med intelligent clienteling. Biprodukter presenterar riktade till en kunds intresse och inköp vanor, produktrekommendationer återförsäljare kan hjälpa till med medföljande och förbättra kundvård. I Dynamics 365 - för återförsäljning, är produktrekommendationer utrustade med kognitiva tjänster och Microsoft Azure maskin utbildning. |
...
| Få mer information om försändelsesupport i Dynamics 365 for Operations                                                                                                         | Mer information om stöd för försändelse processer finns [försändelse](/dynamics365/operations/scm/inventory/consignment), [Skapa försändelse](/dynamics365/operations/scm/inventory/set-up-consignment), [skapa påfyllningsorder en försändelse (aktivitet guide)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), och [ändra ägarskap för försändelse lagret utifrån produktionsbehov (aktivitet guide)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| Få mer information om support för leverantörssamarbete i Dynamics 365 for Operations. | Mer information om leverantörssamarbete finns i [Leverantörssamarbete med externa leverantörer](/dynamics365/operations/scm/procurement/vendor-collaboration-work-external-vendors), [Vendor collaboration with customers](/dynamics365/operations/scm/procurement/vendor-collaboration-work-customers-dynamics-365-operations), [Hantera användare av leverantörssamarbete](/dynamics365/operations/scm/procurement/manage-vendor-collaboration-users), [Skapa och underhåll leverantörssamarbeten](/dynamics365/operations/scm/procurement/set-up-maintain-vendor-collaboration) och [Faktureringsarbetsyta för leverantörssamarbeten](/dynamics365/operations/financials/accounts-payable/vendor-portal-invoicing-workspace).                                                         |
...
<tbody>
<tr class="odd">
<td>Definiera direkt på försäljningsorderrader, där efterfrågan ska anskaffas från och hur den ska anskaffas. <strong>Till exempel</strong> ange leveranstypen Direktleverans och skapa en försäljningsorderrad. Den primära leverantören läggs till i försäljningsorderraden som anskaffningspunkt.</td>
...
<tr class="even">
<td>Skapa ett orderlöfte direkt från försäljningsorderrader. <strong>Till exempel</strong> skapa en försäljningsorderrad är stora försörjningskedja från en koncernintern leverantör. Lämna raden. Leveransdatum beräknas enligt tillgänglighet i anskaffningsföretaget.</td>
