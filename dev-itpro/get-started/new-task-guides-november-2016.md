...
| **\***Skapa en order för lagerpåfyllnad för försändelse                                 | Globalt         |
...
| **\***Konfigurera inlärningsdrivna produktrekommendationer för maskin | Globalt         |
| Konfigurera funktionsprofilen för en säljare   | Globalt         |
| **\***Skapa en visuell kassaprofil (november 2016)                | Globalt         |
...
| **\***Skapa ett nytt menyalternativ för avstämning av registreringsskylt      | Globalt         |
...
| Skapa in automatisk fraktavstämning                                     | Globalt         |
